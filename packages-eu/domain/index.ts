...
export namespace domain {
 ...
 - invisible -> Redirection by html frame
        ...
        export namespace dynHost {
            /**
             * DNS zone dynHost login
             * interface fullName: domain.zone.dynHost.Login.Login
             */
            ...
            /**
             * DNS zone dynHost login password change
             * interface fullName: domain.zone.dynHost.LoginChangePassword.LoginChangePassword
             */
             ...
             * interface fullName: domain.zone.dynHost.LoginCreate.LoginCreate
             */
             ...
             * interface fullName: domain.zone.dynHost.Record.Record
             */
            export interface Record {
                id: number;
                ip: string;
        ...
        $(zoneName: string): {
            ...
            dynHost: {
                login: {
                     ...
                     */
                    $post(params: { loginSuffix: string, password: string, subDomain: string }): Promise<domain.zone.dynHost.Login>;
                    /**
                     * Controle cache
                     */
                    $cache(param?: ICacheOptions | CacheAction): Promise<any>;
                    $(login: string): {
                         ...
                         */
                        $get(): Promise<domain.zone.dynHost.Login>;
                        /**
                ...
                record: {
                     ...
                     */
                    $post(params?: { id?: number, ip?: string, subDomain?: string, ttl?: number, zone?: string }): Promise<domain.zone.dynHost.Record>;
                    /**
                     * Controle cache
                     */
                    $cache(param?: ICacheOptions | CacheAction): Promise<any>;
                    $(id: number): {
                         ...
                         */
                        $get(): Promise<domain.zone.dynHost.Record>;
                        /**
