...
export declare namespace nichandle {
    ...
    type CreationRulesActionEnum = "create" | "update";
 ...
 */
export declare function proxyNewAccount(ovhEngine: OvhRequestable): NewAccount;
 ...
 */ export interface NewAccount {
    $post(params: {
        ...
        vat?: string;
        zip?: string;
    }): Promise<nichandle.NewAccountAndToken>;
    area: {
        $get(params: {
            country: nichandle.CountryEnum;
        }): Promise<string[]>;
    ...
    contracts: {
        $get(params: {
            company: nichandle.OvhCompanyEnum;
            subsidiary: nichandle.OvhSubsidiaryEnum;
        }): Promise<order.Contract[]>;
    };
    corporationType: {
        $get(params: {
            country: nichandle.CountryEnum;
    ...
    creationRules: {
        $get(params: {
            ...
            ovhCompany: nichandle.OvhCompanyEnum;
            ovhSubsidiary: nichandle.OvhSubsidiaryEnum;
        }): Promise<nichandle.CreationRules>;
    };
    legalform: {
        $get(params: {
            country: nichandle.CountryEnum;
    ...
    rules: {
        $post(params?: {
            action?: nichandle.CreationRulesActionEnum;
            address?: string;
            area?: string;
            birthCity?: string;
            birthDay?: string;
            ...
            vat?: string;
            zip?: string;
        }): Promise<nichandle.CreationRule[]>;
    };
    /**
     * All available areas for a given country
     * All available areas for a given country
     */
    get(path: '/newAccount/area'): (params: {
        country: nichandle.CountryEnum;
    }) => Promise<string[]>;
    /**
     ...
     * Returns the contracts that governs the creation of an OVH identifier
     */
    get(path: '/newAccount/contracts'): (params: {
        company: nichandle.OvhCompanyEnum;
        subsidiary: nichandle.OvhSubsidiaryEnum;
    }) => Promise<order.Contract[]>;
    /**
     ...
     * All available corporation types for a given country
     */
    get(path: '/newAccount/corporationType'): (params: {
        country: nichandle.CountryEnum;
    }) => Promise<string[]>;
    /**
     ...
     * All available countries for an ovh company and an ovh subsidiary
     */
    get(path: '/newAccount/countries'): (params: {
        ovhCompany: nichandle.OvhCompanyEnum;
        ovhSubsidiary: nichandle.OvhSubsidiaryEnum;
    }) => Promise<nichandle.CountryEnum[]>;
    /**
     ...
     * Give all the rules to follow in order to create an OVH identifier
     */
    get(path: '/newAccount/creationRules'): (params: {
        country: nichandle.CountryEnum;
        legalform: nichandle.LegalFormEnum;
        ovhCompany: nichandle.OvhCompanyEnum;
        ovhSubsidiary: nichandle.OvhSubsidiaryEnum;
     ...
     * All available legal forms for a given country
     */
    get(path: '/newAccount/legalform'): (params: {
        country: nichandle.CountryEnum;
    }) => Promise<string[]>;
    /**
     ...
     * Give all the rules to follow in order to create and update an OVH identifier
     */
    post(path: '/newAccount/rules'): (params?: {
        action?: nichandle.CreationRulesActionEnum;
        address?: string;
        area?: string;
        birthCity?: string;
