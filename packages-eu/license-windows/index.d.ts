...
export declare namespace license {
    ...
    interface OrderableWindowsCompatibilityInfos {
    ...
    interface WindowsOrderConfiguration {
 ...
 */ export interface License {
    windows: {
        ...
        orderableVersions: {
            $get(params: {
                ip: string;
            }): Promise<license.WindowsOrderConfiguration[]>;
        };
        $(serviceName: string): {
            ...
            sqlServer: {
                $post(params: {
                    licenseId: string;
                    version: license.WindowsSqlVersionEnum;
     ...
     */
    get(path: '/license/windows/{serviceName}'): (params: {
        serviceName: string;
    }) => Promise<license.windows.Windows>;
    /**
     * List the license.Option objects
     * options attached to this license
     */
    get(path: '/license/windows/{serviceName}/option'): (params: {
        serviceName: string;
     ...
     * Get this object properties
     */
    get(path: '/license/windows/{serviceName}/option/{label}'): (params: {
        label: license.OptionLabel;
        serviceName: string;
     ...
     * Get this object properties
     */
    get(path: '/license/windows/{serviceName}/serviceInfos'): (params: {
        serviceName: string;
     ...
     */
    get(path: '/license/windows/{serviceName}/tasks'): (params: {
        serviceName: string;
        action?: license.ActionType;
        status?: license.TaskStateEnum;
    }) => Promise<number[]>;
     ...
     * Get this object properties
     */
    get(path: '/license/windows/{serviceName}/tasks/{taskId}'): (params: {
        serviceName: string;
        taskId: number;
    }) => Promise<license.Task>;
    /**
     ...
     * Get the orderable Windows versions
     */
    get(path: '/license/windows/orderableVersions'): (params: {
        ip: string;
    }) => Promise<license.WindowsOrderConfiguration[]>;
    /**
     * Your Windows license
     ...
     */
    put(path: '/license/windows/{serviceName}'): (params: {
        serviceName: string;
        creation?: string;
        deleteAtExpiration?: boolean;
        domain?: string;
     ...
     * Alter this object properties
     */
    put(path: '/license/windows/{serviceName}/serviceInfos'): (params: {
        serviceName: string;
        canDeleteAtExpiration?: boolean;
        contactAdmin?: string;
        contactBilling?: string;
     ...
     * Confirm termination of your service
     */
    post(path: '/license/windows/{serviceName}/confirmTermination'): (params: {
        serviceName: string;
        commentary?: string;
        futureUse?: service.TerminationFutureUseEnum;
        reason?: service.TerminationReasonEnum;
     ...
     */
    post(path: '/license/windows/{serviceName}/sqlServer'): (params: {
        serviceName: string;
        licenseId: string;
        version: license.WindowsSqlVersionEnum;
    }) => Promise<license.Task>;
     ...
     * Terminate your service
     */
    post(path: '/license/windows/{serviceName}/terminate'): (params: {
        serviceName: string;
    }) => Promise<string>;
    /**
     * Your License options
     * release this Option
     */
    delete(path: '/license/windows/{serviceName}/option/{label}'): (params: {
        label: license.OptionLabel;
        serviceName: string;
    }) => Promise<license.Task>;
}
