...
export declare namespace license {
    ...
    type DomainNumberEnum = "0" | "1" | "10" | "100" | "30" | "300" | "unlimited";
    ...
    interface OrderablePleskCompatibilityInfos {
    ...
    interface PleskOrderConfiguration {
    ...
    type PotentialProblemPleskEnum = "isHostOsHyperVLike" | "isHostOsVMwareLike" | "isHostOsVirtuozzo4Like" | "isHostOsXenLike" | "isLinuxOs" | "isOsCloudLinux" | "isOsPlesk10andLater" | "isOsPlesk12" | "isOsPleskOnyx" | "isWindowsOs";
 ...
 */ export interface License {
    plesk: {
        ...
        orderableVersions: {
            $get(params: {
                ip: string;
            }): Promise<license.PleskOrderConfiguration[]>;
        };
        $(serviceName: string): {
     ...
     */
    get(path: '/license/plesk/{serviceName}'): (params: {
        serviceName: string;
    }) => Promise<license.plesk.Plesk>;
    /**
     * allowedDestinationIp operations
     * Returns an array of ips where the license can be moved to
     */
    get(path: '/license/plesk/{serviceName}/allowedDestinationIp'): (params: {
        serviceName: string;
    }) => Promise<string[]>;
    /**
     ...
     */
    get(path: '/license/plesk/{serviceName}/canLicenseBeMovedTo'): (params: {
        serviceName: string;
        destinationIp: string;
    }) => Promise<license.ChangeIpStatus>;
    /**
     ...
     */
    get(path: '/license/plesk/{serviceName}/option'): (params: {
        serviceName: string;
     ...
     * Get this object properties
     */
    get(path: '/license/plesk/{serviceName}/option/{label}'): (params: {
        label: license.OptionLabel;
        serviceName: string;
     ...
     * Get this object properties
     */
    get(path: '/license/plesk/{serviceName}/serviceInfos'): (params: {
        serviceName: string;
     ...
     */
    get(path: '/license/plesk/{serviceName}/tasks'): (params: {
        serviceName: string;
        action?: license.ActionType;
        status?: license.TaskStateEnum;
    }) => Promise<number[]>;
     ...
     * Get this object properties
     */
    get(path: '/license/plesk/{serviceName}/tasks/{taskId}'): (params: {
        serviceName: string;
        taskId: number;
    }) => Promise<license.Task>;
    /**
     ...
     * Get the orderable Plesk versions and their associated compatibilities
     */
    get(path: '/license/plesk/orderableVersions'): (params: {
        ip: string;
    }) => Promise<license.PleskOrderConfiguration[]>;
    /**
     * Your Plesk license
     ...
     */
    put(path: '/license/plesk/{serviceName}'): (params: {
        serviceName: string;
        creation?: string;
        deleteAtExpiration?: boolean;
        domain?: string;
     ...
     * Alter this object properties
     */
    put(path: '/license/plesk/{serviceName}/serviceInfos'): (params: {
        serviceName: string;
        canDeleteAtExpiration?: boolean;
        contactAdmin?: string;
        contactBilling?: string;
     ...
     */
    post(path: '/license/plesk/{serviceName}/changeIp'): (params: {
        serviceName: string;
        destinationIp: string;
    }) => Promise<license.Task>;
    /**
     ...
     * Confirm termination of your service
     */
    post(path: '/license/plesk/{serviceName}/confirmTermination'): (params: {
        serviceName: string;
        commentary?: string;
        futureUse?: service.TerminationFutureUseEnum;
        reason?: service.TerminationReasonEnum;
     ...
     * Terminate your service
     */
    post(path: '/license/plesk/{serviceName}/terminate'): (params: {
        serviceName: string;
    }) => Promise<string>;
    /**
     * Your License options
     * release this Option
     */
    delete(path: '/license/plesk/{serviceName}/option/{label}'): (params: {
        label: license.OptionLabel;
        serviceName: string;
    }) => Promise<license.Task>;
}
