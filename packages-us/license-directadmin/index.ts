 ...
 * Source: https://api.us.ovhcloud.com/1.0/license/directadmin.json
 */
export namespace license {
    ...
    export type DirectAdminVersionEnum = "directadmin-license"
    ...
    export type OrderableDirectAdminVersionEnum = "directadmin-license"
...
// Api
   ...
   */
  get(path: '/license/directadmin/{serviceName}'): (params: {serviceName: string}) => Promise<license.directadmin.DirectAdmin>;
  /**
   * allowedDestinationIp operations
   * Returns an array of ips where the license can be moved to
   */
  get(path: '/license/directadmin/{serviceName}/allowedDestinationIp'): (params: {serviceName: string}) => Promise<string[]>;
  /**
   * canLicenseBeMovedTo operations
   * Will tell if the ip can accept the license
   */
  get(path: '/license/directadmin/{serviceName}/canLicenseBeMovedTo'): (params: {serviceName: string, destinationIp: string}) => Promise<license.ChangeIpStatus>;
  /**
   * Details about a Service
   * Get this object properties
   */
  get(path: '/license/directadmin/{serviceName}/serviceInfos'): (params: {serviceName: string}) => Promise<services.Service>;
  /**
   ...
   * Get this object properties
   */
  get(path: '/license/directadmin/{serviceName}/tasks/{taskId}'): (params: {serviceName: string, taskId: number}) => Promise<license.Task>;
  /**
   * Get the orderable DirectAdmin versions
   * Get the orderable DirectAdmin versions
   */
  get(path: '/license/directadmin/orderableVersions'): (params: {ip: string}) => Promise<license.DirectAdminOrderConfiguration[]>;
  /**
   * Your DirectAdmin license
   ...
   */
  post(path: '/license/directadmin/{serviceName}/changeIp'): (params: {serviceName: string, destinationIp: string}) => Promise<license.Task>;
  /**
   * changeOs operations
   ...
   * Confirm termination of your service
   */
  post(path: '/license/directadmin/{serviceName}/confirmTermination'): (params: {serviceName: string, commentary?: string, futureUse?: service.TerminationFutureUseEnum, reason?: service.TerminationReasonEnum, token: string}) => Promise<string>;
  /**
