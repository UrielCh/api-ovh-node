...
// imported from https://eu.api.ovh.com:443/1.0/stack/mis.json
      ...
      "operations": [
        {
          ...
          "parameters": [
            {
              "dataType": "string",
              "description": "The internal name of your MIS service",
              "fullType": "string",
              "name": "serviceName",
              "paramType": "path",
              "required": true
          ...
          "responseType": "stack.mis.productWithIAM"
        }
      ],
      ...
      "operations": [
        {
          ...
          "iamActions": [
            {
              "name": "stackMis:apiovh:serviceInfos/get",
              "required": true
            }
          ],
          "noAuthentication": false,
        ...
        },
        {
          ...
          "iamActions": [
            {
              "name": "stackMis:apiovh:serviceInfos/edit",
              "required": true
            }
          ],
          "noAuthentication": false,
