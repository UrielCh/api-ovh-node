...
// imported from https://api.us.ovhcloud.com:443/1.0/license/redhat.json
      ...
      "operations": [
        {
          ...
          "responseType": "license.redhat.RedHatWithIAM"
        },
        {
          "apiStatus": {
            "description": "Beta version",
      ...
      "operations": [
        {
          ...
          "iamActions": [
            {
              "name": "licenseRedHat:apiovh:confirmTermination",
              "required": true
            }
          ],
          "noAuthentication": false,
      ...
      "operations": [
        {
          ...
          "iamActions": [
            {
              "name": "licenseRedHat:apiovh:serviceInfos/get",
              "required": true
            }
          ],
          "noAuthentication": false,
        ...
        },
        {
          ...
          "iamActions": [
            {
              "name": "licenseRedHat:apiovh:serviceInfos/edit",
              "required": true
            }
          ],
          "noAuthentication": false,
      ...
      "operations": [
        {
          ...
          "iamActions": [
            {
              "name": "licenseRedHat:apiovh:tasks/get",
              "required": true
            }
          ],
          "noAuthentication": false,
      ...
      "operations": [
        {
          ...
          "iamActions": [
            {
              "name": "licenseRedHat:apiovh:terminate",
              "required": true
            }
          ],
