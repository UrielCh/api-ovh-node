...
// imported from https://api.us.ovhcloud.com:443/1.0/license/virtuozzo.json
  ...
  "models": {
    ...
    "license.OrderableVirtuozzoCompatibilityInfos": {
      ...
      "properties": {
        ...
        "potentialProblems": {
          "canBeNull": false,
          "fullType": "license.PotentialProblemVirtuozzoEnum[]",
          "readOnly": false,
          "required": true,
    ...
    "license.OrderableVirtuozzoContainerNumberEnum": {
      ...
      "enum": [
        "1-container-for-2-cpu",
        "10-containers-for-2-cpu",
        "100-containers-for-2-cpu",
        "3-containers-for-2-cpu",
        "30-containers-for-2-cpu",
        "60-containers-for-2-cpu"
      ],
      "enumType": "string",
    ...
    "license.VirtuozzoOrderConfiguration": {
      ...
      "properties": {
        "orderableVersions": {
          "canBeNull": false,
          "fullType": "license.OrderableVirtuozzoCompatibilityInfos[]",
          "readOnly": false,
          "required": true,
