...
export const endpoints: { [key: string]: IEndpoint } = {
    'ovh-eu': { host: 'eu.api.ovh.com', directory: 'packages-eu', namespace: 'ovh-api', port: 443 },
    ...
    'soyoustart-eu': { host: 'eu.api.soyoustart.com', directory: 'soyoustart-eu', namespace: 'ovh-soyoustart', port: 443 },
    'soyoustart-ca': { host: 'ca.api.soyoustart.com', directory: 'soyoustart-ca', namespace: 'ovh-soyoustart-ca', port: 443 },
    'kimsufi-eu': { host: 'eu.api.kimsufi.com', directory: 'kimsufi-eu', namespace: 'ovh-kimsufi', port: 443 },
