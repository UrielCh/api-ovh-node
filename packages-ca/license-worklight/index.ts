 ...
 * Source: https://ca.api.ovh.com/1.0/license/worklight.json
 */
...
export namespace license {
    ...
    export namespace worklight {
        ...
        /**
         * Your WorkLight license
         * interface fullName: license.worklight.WorkLightWithIAM.WorkLightWithIAM
         */
        export interface WorkLightWithIAM {
            creation: string;
            deleteAtExpiration: boolean;
            domain: string;
