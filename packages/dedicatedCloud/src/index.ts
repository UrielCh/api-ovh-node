...
type PathsDedicatedCloudPOST = '/dedicatedCloud/{serviceName}/task/{taskId}/changeMaintenanceExecutionDate' | 
...
export class ApiDedicatedCloud extends ApiCommon {
  ...
  **/
  public get(path: '/dedicatedCloud/{serviceName}/task', pathParams: {serviceName: string}, queryParams: {state?: DedicatedCloudTaskStateEnum, name?: string}): Promise<Number[]>;
  /**
  Operation on a Private Cloud component
  Get this object properties
  **/
  ...
  **/
  public get(path: '/dedicatedCloud/{serviceName}/datacenter/{datacenterId}/host/{hostId}/task', pathParams: {serviceName: string, datacenterId: Number, hostId: Number}, queryParams: {state?: DedicatedCloudTaskStateEnum, name?: string}): Promise<Number[]>;
  /**
  hourlyConsumption operations
  ...
  **/
  public get(path: '/dedicatedCloud/{serviceName}/globalTasks', pathParams: {serviceName: string}, queryParams: {'executionDate.from'?: Date, 'endDate.from'?: Date, networkAccessId?: Number, 'endDate.to'?: Date, filerId?: Number, orderId?: Number, vlanId?: Number, parentTaskId?: Number, hostId?: Number, 'lastModificationDate.from'?: Date, 'lastModificationDate.to'?: Date, state?: DedicatedCloudTaskStateEnum[], 'executionDate.to'?: Date, datacenterId?: Number, userId?: Number, name?: string}): Promise<Number[]>;
  /**
  The Private Cloud Nsx option
  Get this object properties
  **/
  ...
  **/
  ...
  public get(path: PathsDedicatedCloudGET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Network allowed to connect to the Private Cloud management interface
  ...
  **/
  ...
  public put(path: PathsDedicatedCloudPUT, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  ...
  **/
  ...
  public post(path: PathsDedicatedCloudPOST, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  Trust IP which can bypass the two factor authentication
  ...
  **/
  ...
  public delete(path: PathsDedicatedCloudDELETE, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
