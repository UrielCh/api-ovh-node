...
type PathsdedicatedserverPOST = '/dedicated/server/{serviceName}/install/start' | 
...
class Apidedicatedserver extends ApiCommon {
  ...
  **/
  public put(path: '/dedicated/server/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Service monitoring details
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}', pathParams: {serviceName?: string, monitoringId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Service monitoring Email alert
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/email/{alertId}', pathParams: {serviceName?: string, monitoringId?: Number, alertId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Monitoring SMS alert details, This service is currently not supported for servers at BHS 
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/sms/{alertId}', pathParams: {serviceName?: string, monitoringId?: Number, alertId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Backup Ftp ACL for this server and Backup Ftp
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/features/backupFTP/access/{ipBlock}', pathParams: {serviceName?: string, ipBlock?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Firewall attached to this server
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/features/firewall', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Server bandwidth burst details
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/burst', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Secondary dns infos
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/secondaryDnsDomains/{domain}', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  SPLA licenses management
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}/spla/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Server informations
  Alter this object properties
  **/
  public put(path: '/dedicated/server/{serviceName}', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathsdedicatedserverPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  start operations
  Start an install
  **/
  public post(path: '/dedicated/server/{serviceName}/install/start', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  hardDiskDrive operations
  Ask for a broken HDD replacement
  **/
  public post(path: '/dedicated/server/{serviceName}/support/replace/hardDiskDrive', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<SupportNewMessageInfo>;
  /**
  Change the contacts of this service
  Launch a contact change procedure
  **/
  public post(path: '/dedicated/server/{serviceName}/changeContact', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<Number[]>;
  /**
  ipMove operations
  Move an Ip failover to this server
  **/
  public post(path: '/dedicated/server/{serviceName}/ipMove', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Confirm termination of your service
  Confirm termination of your service
  **/
  public post(path: '/dedicated/server/{serviceName}/confirmTermination', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  List the dedicated.server.serviceMonitoring objects
  Add a new service monitoring
  **/
  public post(path: '/dedicated/server/{serviceName}/serviceMonitoring', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerServiceMonitoring>;
  /**
  List the dedicated.server.emailAlert objects
  Add a new email alert
  **/
  public post(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/email', pathParams: {serviceName?: string, monitoringId?: Number}, queryParams: null, bodyParams: null): Promise<DedicatedServerEmailAlert>;
  /**
  List the dedicated.server.smsAlert objects
  Create a SMS alert
  **/
  public post(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/sms', pathParams: {serviceName?: string, monitoringId?: Number}, queryParams: null, bodyParams: null): Promise<DedicatedServerSmsAlert>;
  /**
  reboot operations
  Hard reboot this server
  **/
  public post(path: '/dedicated/server/{serviceName}/reboot', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  authenticationSecret operations
  Retrieve secret to connect to the server / application
  **/
  public post(path: '/dedicated/server/{serviceName}/authenticationSecret', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerAccess[]>;
  /**
  windows operations
  Add your existing windows license serial to this dedicated server. Will be manageable in /license/windows.
  **/
  public post(path: '/dedicated/server/{serviceName}/license/windows', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  List the dedicated.server.VirtualMac objects
  Add a virtual mac to an IP address
  **/
  public post(path: '/dedicated/server/{serviceName}/virtualMac', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  List the dedicated.server.VirtualMacManagement objects
  Add an IP to this Virtual MAC
  **/
  public post(path: '/dedicated/server/{serviceName}/virtualMac/{macAddress}/virtualAddress', pathParams: {serviceName?: string, macAddress?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  List the dedicated.server.BackupFtpAcl objects
  Create a new Backup FTP ACL
  **/
  public post(path: '/dedicated/server/{serviceName}/features/backupFTP/access', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  password operations
  Change your Backup FTP password
  **/
  public post(path: '/dedicated/server/{serviceName}/features/backupFTP/password', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Backup Ftp assigned to this server
  Create a new Backup FTP space
  **/
  public post(path: '/dedicated/server/{serviceName}/features/backupFTP', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  resetInterface operations
  Reset KVM IPMI interface
  **/
  public post(path: '/dedicated/server/{serviceName}/features/ipmi/resetInterface', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  access operations
  Request an acces on KVM IPMI interface
  **/
  public post(path: '/dedicated/server/{serviceName}/features/ipmi/access', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  resetSessions operations
  Reset KVM IPMI sessions
  **/
  public post(path: '/dedicated/server/{serviceName}/features/ipmi/resetSessions', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  test operations
  Launch test on KVM IPMI interface
  **/
  public post(path: '/dedicated/server/{serviceName}/features/ipmi/test', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Backup Cloud assigned to this server
  Create a new storage backup space associated to server
  **/
  public post(path: '/dedicated/server/{serviceName}/features/backupCloud', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerBackupCloud>;
  /**
  password operations
  Change your cloud account password
  **/
  public post(path: '/dedicated/server/{serviceName}/features/backupCloud/password', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerBackupBackupPassword>;
  /**
  List the secondaryDns.SecondaryDNS objects
  add a domain on secondary dns
  **/
  public post(path: '/dedicated/server/{serviceName}/secondaryDnsDomains', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  List the dedicated.server.spla objects
  Add a new SPLA license
  **/
  public post(path: '/dedicated/server/{serviceName}/spla', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<Number>;
  /**
  revoke operations
  Revoke an SPLA license
  **/
  public post(path: '/dedicated/server/{serviceName}/spla/{id}/revoke', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  ipBlockMerge operations
  Merge a splitted block and route it to the choosen server. You cannot undo this operation
  **/
  public post(path: '/dedicated/server/{serviceName}/ipBlockMerge', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Terminate your service
  Terminate your service
  **/
  public post(path: '/dedicated/server/{serviceName}/terminate', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  cancel operations
  this action stop the task progression if it's possible
  **/
  public post(path: '/dedicated/server/{serviceName}/task/{taskId}/cancel', pathParams: {serviceName?: string, taskId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  public post(path: PathsdedicatedserverPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Service monitoring details
  Remove this service monitoring
  **/
  public delete(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}', pathParams: {serviceName?: string, monitoringId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Service monitoring Email alert
  Remove this Email alert monitoring
  **/
  public delete(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/email/{alertId}', pathParams: {serviceName?: string, monitoringId?: Number, alertId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Monitoring SMS alert details, This service is currently not supported for servers at BHS 
  Remove this SMS alert
  **/
  public delete(path: '/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/sms/{alertId}', pathParams: {serviceName?: string, monitoringId?: Number, alertId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
   ip address linked with this virtual mac address
  Remove this ip from virtual mac , if you remove the last linked Ip, virtualmac will be deleted
  **/
  public delete(path: '/dedicated/server/{serviceName}/virtualMac/{macAddress}/virtualAddress/{ipAddress}', pathParams: {serviceName?: string, macAddress?: string, ipAddress?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Information about the options of a dedicated server
  Release a given option
  **/
  public delete(path: '/dedicated/server/{serviceName}/option/{option}', pathParams: {serviceName?: string, option?: DedicatedServerOptionEnum}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Backup Ftp ACL for this server and Backup Ftp
  Revoke this ACL
  **/
  public delete(path: '/dedicated/server/{serviceName}/features/backupFTP/access/{ipBlock}', pathParams: {serviceName?: string, ipBlock?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Backup Ftp assigned to this server
  Terminate your Backup FTP service, ALL DATA WILL BE PERMANENTLY DELETED
  **/
  public delete(path: '/dedicated/server/{serviceName}/features/backupFTP', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<DedicatedServerTask>;
  /**
  Backup Cloud assigned to this server
  Deactivate the cloud backup associated to the server. This does not delete container data.
  **/
  public delete(path: '/dedicated/server/{serviceName}/features/backupCloud', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  vrack dedicated server interfaces
  remove this server from this vrack
  **/
  public delete(path: '/dedicated/server/{serviceName}/vrack/{vrack}', pathParams: {serviceName?: string, vrack?: string}, queryParams: null, bodyParams: null): Promise<VrackTask>;
  /**
  Secondary dns infos
  remove this domain
  **/
  public delete(path: '/dedicated/server/{serviceName}/secondaryDnsDomains/{domain}', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public delete(path: PathsdedicatedserverDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
