...
type PathsipGET = '/ip/{ip}/spam/{ipSpamming}' | 
...
type PathsipPUT = '/ip/{ip}/mitigationProfiles/{ipMitigationProfile}' | 
'/ip/{ip}/mitigation/{ipOnMitigation}' | 
'/ip/{ip}/firewall/{ipOnFirewall}' | 
'/ip/{ip}/ripe' | 
'/ip/{ip}/game/{ipOnGame}' | 
...
type PathsipPOST = '/ip/{ip}/spam/{ipSpamming}/unblock' | 
'/ip/{ip}/reverse' | 
'/ip/{ip}/mitigationProfiles' | 
'/ip/{ip}/move' | 
...
type PathsipDELETE = '/ip/{ip}/reverse/{ipReverse}' | 
'/ip/{ip}/mitigationProfiles/{ipMitigationProfile}' | 
'/ip/{ip}/mitigation/{ipOnMitigation}' | 
'/ip/{ip}/delegation/{target}' | 
'/ip/{ip}/firewall/{ipOnFirewall}/rule/{sequence}' | 
...
class Apiip extends ApiCommon {
  ...
  **/
  ...
  Your OVH IPs
  **/
  public get(path: '/ip', pathParams: null, queryParams: {ip?: string, 'routedTo.serviceName'?: string, type?: IpIpTypeEnum, description?: string}): Promise<string[]>;
  public get(path: PathsipGET, pathParams?: any, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Mitigation profile for your ip
  Alter this object properties
  **/
  public put(path: '/ip/{ip}/mitigationProfiles/{ipMitigationProfile}', pathParams: {ip?: string, ipMitigationProfile?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Your IP on mitigation
  Alter this object properties
  **/
  public put(path: '/ip/{ip}/mitigation/{ipOnMitigation}', pathParams: {ip?: string, ipOnMitigation?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Your IP on firewall
  Alter this object properties
  **/
  public put(path: '/ip/{ip}/firewall/{ipOnFirewall}', pathParams: {ip?: string, ipOnFirewall?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  IP block RIPE informations
  Alter this object properties
  **/
  public put(path: '/ip/{ip}/ripe', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  GAME Anti-DDoS
  Alter this object properties
  **/
  public put(path: '/ip/{ip}/game/{ipOnGame}', pathParams: {ip?: string, ipOnGame?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Your IP
  Alter this object properties
  **/
  public put(path: '/ip/{ip}', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Your IP linked to service
  Alter this object properties
  **/
  public put(path: '/ip/service/{serviceName}', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Details about a Service
  Alter this object properties
  **/
  public put(path: '/ip/loadBalancing/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Backends attached to your IP load balancing
  Alter this object properties
  **/
  public put(path: '/ip/loadBalancing/{serviceName}/backend/{backend}', pathParams: {serviceName?: string, backend?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathsipPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  unblock operations
  Release the ip from anti-spam system
  **/
  public post(path: '/ip/{ip}/spam/{ipSpamming}/unblock', pathParams: {ip?: string, ipSpamming?: string}, queryParams: null, bodyParams: null): Promise<IpSpamIp>;
  /**
  List the ip.ReverseIp objects
  Add reverse on an ip
  **/
  public post(path: '/ip/{ip}/reverse', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpReverseIp>;
  /**
  List the ip.MitigationProfile objects
  Create new profile for one of your ip
  **/
  public post(path: '/ip/{ip}/mitigationProfiles', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpMitigationProfile>;
  /**
  move operations
  Move this IP to another service
  **/
  public post(path: '/ip/{ip}/move', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpIpTask>;
  /**
  unblock operations
  Unblock this IP
  **/
  public post(path: '/ip/{ip}/arp/{ipBlocked}/unblock', pathParams: {ip?: string, ipBlocked?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  List the ip.MitigationIp objects
  AntiDDOS option. Add new IP on permanent mitigation
  **/
  public post(path: '/ip/{ip}/mitigation', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpMitigationIp>;
  /**
  changeOrg operations
  Change organisation of this IP
  **/
  public post(path: '/ip/{ip}/changeOrg', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpIpTask>;
  /**
  terminate operations
  Delete a failover IP
  **/
  public post(path: '/ip/{ip}/terminate', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpIpTask>;
  /**
  unblock operations
  Unblock this IP
  **/
  public post(path: '/ip/{ip}/antihack/{ipBlocked}/unblock', pathParams: {ip?: string, ipBlocked?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  List the ip.ReverseDelegation objects
  Add target for reverse delegation on IPv6 subnet
  **/
  public post(path: '/ip/{ip}/delegation', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpReverseDelegation>;
  /**
  List the ip.FirewallNetworkRule objects
  AntiDDOS option. Add new rule on your IP
  **/
  public post(path: '/ip/{ip}/firewall/{ipOnFirewall}/rule', pathParams: {ip?: string, ipOnFirewall?: string}, queryParams: null, bodyParams: null): Promise<IpFirewallNetworkRule>;
  /**
  List the ip.FirewallIp objects
  AntiDDOS option. Add new IP on firewall
  **/
  public post(path: '/ip/{ip}/firewall', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpFirewallIp>;
  /**
  IP migration to OVH
  Generate a migration token
  **/
  public post(path: '/ip/{ip}/migrationToken', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpIpMigrationToken>;
  /**
  park operations
  Park this IP
  **/
  public post(path: '/ip/{ip}/park', pathParams: {ip?: string}, queryParams: null, bodyParams: null): Promise<IpIpTask>;
  /**
  List the ip.GameMitigationRule objects
  Add new rule on your IP
  **/
  public post(path: '/ip/{ip}/game/{ipOnGame}/rule', pathParams: {ip?: string, ipOnGame?: string}, queryParams: null, bodyParams: null): Promise<IpGameMitigationRule>;
  /**
  Confirm termination of your service
  Confirm termination of your service
  **/
  public post(path: '/ip/service/{serviceName}/confirmTermination', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  Terminate your service
  Terminate your service
  **/
  public post(path: '/ip/service/{serviceName}/terminate', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  Change the contacts of this service
  Launch a contact change procedure
  **/
  public post(path: '/ip/service/{serviceName}/changeContact', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<Number[]>;
  /**
  ...
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/restoreSsl', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  importCustomSsl operations
  Import your own ssl certificate on your IP load balancing. Ssl option is needed to use this url.
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/importCustomSsl', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  ...
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/stickiness', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  List the portsRedirection objects
  Add a new port redirection
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/portsRedirection', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  ...
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/backend/{backend}/backupState', pathParams: {serviceName?: string, backend?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  ...
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/backend/{backend}/setWeight', pathParams: {serviceName?: string, backend?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  List the ip.LoadBalancingBackendIp objects
  Add a new backend on your IP load balancing
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/backend', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  ...
  **/
  public post(path: '/ip/loadBalancing/{serviceName}/switchToIplbNextGenerationApi', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingTaskTask>;
  public post(path: PathsipPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Your reverse records on IP
  Delete a reverse on one IP
  **/
  public delete(path: '/ip/{ip}/reverse/{ipReverse}', pathParams: {ip?: string, ipReverse?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Mitigation profile for your ip
  Delete mitigation profile
  **/
  public delete(path: '/ip/{ip}/mitigationProfiles/{ipMitigationProfile}', pathParams: {ip?: string, ipMitigationProfile?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Your IP on mitigation
  AntiDDOS option. Delete IP from mitigation
  **/
  public delete(path: '/ip/{ip}/mitigation/{ipOnMitigation}', pathParams: {ip?: string, ipOnMitigation?: string}, queryParams: null, bodyParams: null): Promise<IpMitigationIp>;
  /**
  Your reverse delegations on IPv6 subnet
  Delete a target for reverse delegation on IPv6 subnet
  **/
  public delete(path: '/ip/{ip}/delegation/{target}', pathParams: {ip?: string, target?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Rule on ip
  AntiDDOS option. Delete rule
  **/
  public delete(path: '/ip/{ip}/firewall/{ipOnFirewall}/rule/{sequence}', pathParams: {ip?: string, ipOnFirewall?: string, sequence?: Number}, queryParams: null, bodyParams: null): Promise<IpFirewallNetworkRule>;
  /**
  Your IP on firewall
  AntiDDOS option. Delete IP and rules from firewall
  **/
  public delete(path: '/ip/{ip}/firewall/{ipOnFirewall}', pathParams: {ip?: string, ipOnFirewall?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  Rule on ip:ports
  Delete rule
  **/
  public delete(path: '/ip/{ip}/game/{ipOnGame}/rule/{id}', pathParams: {ip?: string, ipOnGame?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<IpGameMitigationRule>;
  /**
  Port redirections
  Delete a port redirection
  **/
  public delete(path: '/ip/loadBalancing/{serviceName}/portsRedirection/{srcPort}', pathParams: {serviceName?: string, srcPort?: IpLoadBalancingAdditionalPortEnum}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  /**
  Backends attached to your IP load balancing
  Remove a backend IP
  **/
  public delete(path: '/ip/loadBalancing/{serviceName}/backend/{backend}', pathParams: {serviceName?: string, backend?: string}, queryParams: null, bodyParams: null): Promise<IpLoadBalancingTask>;
  public delete(path: PathsipDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
