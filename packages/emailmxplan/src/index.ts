...
class Apiemailmxplan extends ApiCommon {
  ...
  **/
  public get(path: '/email/mxplan/{service}/account', pathParams: {service?: string}, queryParams: {primaryEmailAddress?: string, id?: Number}): Promise<string[]>;
  /**
  List the email.pro.Task objects
  Pending actions
  **/
  ...
  **/
  public get(path: '/email/mxplan/{service}/externalContact', pathParams: {service?: string}, queryParams: {displayName?: string, lastName?: string, id?: Number, externalEmailAddress?: string, firstName?: string}): Promise<string[]>;
  /**
  External contact for this mxplan service
  Get this object properties
  **/
  ...
  **/
  public put(path: '/email/mxplan/{service}/account/{email}', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Domain
  Alter this object properties
  **/
  public put(path: '/email/mxplan/{service}/domain/{domainName}', pathParams: {service?: string, domainName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  disclaimer
  Alter this object properties
  **/
  public put(path: '/email/mxplan/{service}/domain/{domainName}/disclaimer', pathParams: {service?: string, domainName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  External contact for this mxplan service
  Alter this object properties
  **/
  public put(path: '/email/mxplan/{service}/externalContact/{externalEmailAddress}', pathParams: {service?: string, externalEmailAddress?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  MXPlan service
  Alter this object properties
  **/
  public put(path: '/email/mxplan/{service}', pathParams: {service?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathsemailmxplanPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  List the email.mxplan.AccountAlias objects
  Create new alias
  **/
  public post(path: '/email/mxplan/{service}/account/{email}/alias', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  List the email.mxplan.AccountFullAccess objects
  Allow full access to a user
  **/
  public post(path: '/email/mxplan/{service}/account/{email}/fullAccess', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  List the email.mxplan.AccountSendOnBehalfTo objects
  Allow another user to Send On Behalf To mails from this mailbox
  **/
  public post(path: '/email/mxplan/{service}/account/{email}/sendOnBehalfTo', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  changePassword operations
  Change mailbox password
  **/
  public post(path: '/email/mxplan/{service}/account/{email}/changePassword', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  Account Diagnosis
  Create new diagnosis request
  **/
  public post(path: '/email/mxplan/{service}/account/{email}/diagnostic', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  List the email.mxplan.AccountSendAs objects
  Allow another user to send mails from this mailbox
  **/
  public post(path: '/email/mxplan/{service}/account/{email}/sendAs', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  disclaimer
  Create organization disclaimer of each email
  **/
  public post(path: '/email/mxplan/{service}/domain/{domainName}/disclaimer', pathParams: {service?: string, domainName?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  List the email.mxplan.ExternalContact objects
  create new external contact
  **/
  public post(path: '/email/mxplan/{service}/externalContact', pathParams: {service?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  updateFlagsOnAllAccounts operations
  Update spam and virus flags on all active accounts
  **/
  public post(path: '/email/mxplan/{service}/updateFlagsOnAllAccounts', pathParams: {service?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public post(path: PathsemailmxplanPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Aliases on this mailbox
  Delete existing alias
  **/
  public delete(path: '/email/mxplan/{service}/account/{email}/alias/{alias}', pathParams: {service?: string, email?: string, alias?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  Users having full access on this mailbox
  Revoke full access
  **/
  public delete(path: '/email/mxplan/{service}/account/{email}/fullAccess/{allowedAccountId}', pathParams: {service?: string, email?: string, allowedAccountId?: Number}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  Get users authorized to Send On Behalf To mails from this mailbox
  Delete allowed user for SendOnBehalfTo
  **/
  public delete(path: '/email/mxplan/{service}/account/{email}/sendOnBehalfTo/{allowedAccountId}', pathParams: {service?: string, email?: string, allowedAccountId?: Number}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  Mailbox
  Delete existing mailbox in mxplan server
  **/
  public delete(path: '/email/mxplan/{service}/account/{email}', pathParams: {service?: string, email?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  Users authorized to send mails from this mailbox
  Delete allowed user for sendAs
  **/
  public delete(path: '/email/mxplan/{service}/account/{email}/sendAs/{allowedAccountId}', pathParams: {service?: string, email?: string, allowedAccountId?: Number}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  disclaimer
  Delete existing organization disclaimer
  **/
  public delete(path: '/email/mxplan/{service}/domain/{domainName}/disclaimer', pathParams: {service?: string, domainName?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  /**
  External contact for this mxplan service
  delete external contact
  **/
  public delete(path: '/email/mxplan/{service}/externalContact/{externalEmailAddress}', pathParams: {service?: string, externalEmailAddress?: string}, queryParams: null, bodyParams: null): Promise<EmailProTask>;
  public delete(path: PathsemailmxplanDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
