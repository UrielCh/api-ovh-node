...
type PathsorderGET = '/order/veeamCloudConnect' | 
...
type PathsorderPOST = '/order/veeamCloudConnect/{serviceName}/upgrade/{duration}' | 
'/order/saas/csp2/new/{duration}' | 
'/order/cart' | 
'/order/cart/{cartId}/licenseWorklight' | 
'/order/cart/{cartId}/privateCloudCDI' | 
...
class Apiorder extends ApiCommon {
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/saas/csp2/new/{duration}', pathParams: {duration?: string}, queryParams: {officeProPlusQuantity?: Number, giftCode?: string, officeBusinessQuantity?: Number}): Promise<OrderOrder>;
  /**
  Create an order for a new office tenant
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/saas/csp2/new', pathParams: null, queryParams: {officeProPlusQuantity?: Number, giftCode?: string, officeBusinessQuantity?: Number}): Promise<string[]>;
  /**
  Missing description
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/dedicated/nasha/new/{duration}', pathParams: {duration?: string}, queryParams: {model?: DedicatedNasHAOfferEnum, datacenter?: DedicatedNasHAZoneEnum}): Promise<OrderOrder>;
  /**
  Order a new Nas HA
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/dedicated/nasha/new', pathParams: null, queryParams: {model?: DedicatedNasHAOfferEnum, datacenter?: DedicatedNasHAZoneEnum}): Promise<string[]>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/overTheBox/{serviceName}/migrate', pathParams: {serviceName?: string}, queryParams: {hardware?: boolean, offer?: string, shippingMethod?: OverTheBoxShippingMethodEnum, shippingContactID?: string, shippingRelayID?: Number}): Promise<OrderOrder>;
  /**
  Subscribe to overTheBox service
  Get prices and contracts information
  **/
  public get(path: '/order/overTheBox/new/{duration}', pathParams: {duration?: string}, queryParams: {offer?: string, voucher?: string, deviceId?: string}): Promise<OrderOrder>;
  /**
  Subscribe to overTheBox service
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/overTheBox/new', pathParams: null, queryParams: {offer?: string, voucher?: string, deviceId?: string}): Promise<string[]>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/{billingAccount}/numberGeographic', pathParams: {billingAccount?: string}, queryParams: {pool?: TelephonyNumberPoolEnum, email?: string, retractation?: boolean, zone?: string, country?: TelephonyNumberCountryEnum, ape?: string, city?: string, siret?: string, offer?: TelephonyNumberOffer, streetNumber?: string, socialNomination?: string, zip?: string, streetName?: string, organisation?: string, name?: string, specificNumber?: string, displayUniversalDirectory?: boolean, legalform?: NichandleLegalFormEnum, phone?: string, firstname?: string}): Promise<OrderOrder>;
  /**
  Purchase a new standard alias number
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/{billingAccount}/numberNogeographic', pathParams: {billingAccount?: string}, queryParams: {retractation?: boolean, pool?: TelephonyNumberPoolEnum, email?: string, city?: string, ape?: string, country?: TelephonyNumberCountryEnum, siret?: string, streetName?: string, name?: string, organisation?: string, offer?: TelephonyNumberOffer, streetNumber?: string, zip?: string, socialNomination?: string, phone?: string, legalform?: NichandleLegalFormEnum, displayUniversalDirectory?: boolean, firstname?: string, specificNumber?: string}): Promise<OrderOrder>;
  /**
  Order a new portability
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/{billingAccount}/portability', pathParams: {billingAccount?: string}, queryParams: {offer?: TelephonyPortabilityOfferType, specialNumberCategory?: TelephonyPortabilitySpecialNumberCategoryEnum, streetNumber?: Number, zip?: string, streetNumberExtra?: string, socialReason?: TelephonyPortabilitySocialReason, streetName?: string, building?: string, name?: string, callNumber?: string, floor?: Number, executeAsSoonAsPossible?: boolean, door?: string, rio?: string, mobilePhone?: string, desireDate?: Date, stair?: Number, displayUniversalDirectory?: boolean, firstName?: string, streetType?: string, contactNumber?: string, contactName?: string, type?: TelephonyPortabilityNumberType, listNumbers?: string, fiabilisation?: boolean, city?: string, country?: TelephonyPortabilityCountriesAvailable, siret?: string, lineToRedirectAliasTo?: string}): Promise<OrderOrder>;
  /**
  Purchase a new line offer
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/{billingAccount}/line', pathParams: {billingAccount?: string}, queryParams: {quantity?: Number, types?: TelephonyLineTypeEnum[], zones?: string[], mondialRelayId?: string, brand?: string, ownerContactIds?: Number[], offers?: string[], retractation?: boolean, shippingContactId?: Number, displayUniversalDirectories?: boolean[], extraSimultaneousLines?: Number[]}): Promise<OrderOrder>;
  /**
  List available options for this service
  Get allowed options
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/{billingAccount}/accessories', pathParams: {billingAccount?: string}, queryParams: {retractation?: boolean, mondialRelayId?: string, accessories?: string[], shippingContactId?: Number}): Promise<OrderOrder>;
  /**
  Purchase a new standard alias number
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/{billingAccount}/numberSpecial', pathParams: {billingAccount?: string}, queryParams: {firstname?: string, range?: string, displayUniversalDirectory?: boolean, legalform?: NichandleLegalFormEnum, phone?: string, specificNumber?: string, organisation?: string, name?: string, streetName?: string, socialNomination?: string, zip?: string, streetNumber?: string, siret?: string, country?: TelephonyNumberCountryEnum, ape?: string, city?: string, typology?: TelephonyNumberSpecialTypologyEnum, retractation?: boolean, email?: string, pool?: TelephonyNumberPoolEnum}): Promise<OrderOrder>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/telephony/spare/new', pathParams: null, queryParams: {shippingContactId?: Number, brand?: string, quantity?: Number, mondialRelayId?: string}): Promise<OrderOrder>;
  /**
  List available options for this service
  Get allowed options
  **/
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/license/plesk/new/{duration}', pathParams: {duration?: string}, queryParams: {applicationSet?: LicensePleskApplicationSetEnum, domainNumber?: LicenseOrderablePleskDomainNumberEnum, serviceType?: LicenseLicenseTypeEnum, resellerManagement?: boolean, ip?: string, antivirus?: LicenseOrderableAntivirusEnum, version?: LicensePleskVersionEnum, wordpressToolkit?: boolean, languagePackNumber?: LicenseOrderablePleskLanguagePackEnum, powerpack?: boolean}): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/license/plesk/new', pathParams: null, queryParams: {applicationSet?: LicensePleskApplicationSetEnum, domainNumber?: LicenseOrderablePleskDomainNumberEnum, serviceType?: LicenseLicenseTypeEnum, resellerManagement?: boolean, ip?: string, antivirus?: LicenseOrderableAntivirusEnum, version?: LicensePleskVersionEnum, wordpressToolkit?: boolean, languagePackNumber?: LicenseOrderablePleskLanguagePackEnum, powerpack?: boolean}): Promise<string[]>;
  /**
  ...
  **/
  ...
  Get allowed durations for 'upgrade' option
  **/
  public get(path: '/order/license/plesk/{serviceName}/upgrade', pathParams: {serviceName?: string}, queryParams: {antivirus?: LicenseOrderableAntivirusEnum, antispam?: LicenseOrderableAntispamEnum, resellerManagement?: boolean, domainNumber?: LicenseOrderablePleskDomainNumberEnum, applicationSet?: LicensePleskApplicationSetEnum, powerpack?: boolean, languagePackNumber?: LicenseOrderablePleskLanguagePackEnum, wordpressToolkit?: boolean, version?: LicensePleskVersionEnum}): Promise<string[]>;
  /**
  Upgrade this license with some given options
  Get prices and contracts information
  **/
  public get(path: '/order/license/plesk/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, queryParams: {antivirus?: LicenseOrderableAntivirusEnum, antispam?: LicenseOrderableAntispamEnum, resellerManagement?: boolean, domainNumber?: LicenseOrderablePleskDomainNumberEnum, applicationSet?: LicensePleskApplicationSetEnum, powerpack?: boolean, languagePackNumber?: LicenseOrderablePleskLanguagePackEnum, wordpressToolkit?: boolean, version?: LicensePleskVersionEnum}): Promise<OrderOrder>;
  /**
  List available options for this service
  Get allowed options
  **/
  ...
  **/
  ...
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/license/cpanel/new', pathParams: null, queryParams: {ip?: string, version?: LicenseOrderableCpanelVersionEnum, serviceType?: LicenseLicenseTypeEnum}): Promise<string[]>;
  /**
  Upgrade this license with some given options
  Get allowed durations for 'upgrade' option
  **/
  ...
  **/
  ...
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/license/directadmin/new', pathParams: null, queryParams: {ip?: string, version?: LicenseOrderableDirectAdminVersionEnum, serviceType?: LicenseLicenseTypeEnum}): Promise<string[]>;
  /**
  Order a new license on a given Ip with some given options
  Get prices and contracts information
  **/
  public get(path: '/order/license/directadmin/new/{duration}', pathParams: {duration?: string}, queryParams: {ip?: string, version?: LicenseOrderableDirectAdminVersionEnum, serviceType?: LicenseLicenseTypeEnum}): Promise<OrderOrder>;
  /**
  Operations about the LICENSE service
  List available services
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/license/windows/new/{duration}', pathParams: {duration?: string}, queryParams: {serviceType?: LicenseLicenseTypeEnum, version?: LicenseWindowsOsVersionEnum, sqlVersion?: LicenseWindowsSqlVersionEnum, ip?: string}): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/license/windows/new', pathParams: null, queryParams: {serviceType?: LicenseLicenseTypeEnum, version?: LicenseWindowsOsVersionEnum, sqlVersion?: LicenseWindowsSqlVersionEnum, ip?: string}): Promise<string[]>;
  /**
  Upgrade this license with some given options
  Get allowed durations for 'upgrade' option
  **/
  ...
  **/
  ...
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/license/cloudLinux/new', pathParams: null, queryParams: {ip?: string, version?: LicenseCloudLinuxVersionEnum}): Promise<string[]>;
  /**
  Order a new license on a given Ip with some given options
  Get prices and contracts information
  **/
  public get(path: '/order/license/cloudLinux/new/{duration}', pathParams: {duration?: string}, queryParams: {ip?: string, version?: LicenseCloudLinuxVersionEnum}): Promise<OrderOrder>;
  /**
  Missing description
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/domain/zone/new', pathParams: null, queryParams: {zoneName?: string, minimized?: boolean}): Promise<OrderOrder>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/hosting/web/{serviceName}/changeMainDomain/{duration}', pathParams: {serviceName?: string, duration?: string}, queryParams: {mxplan?: HostingWebOrderMxPlanEnum, domain?: string}): Promise<OrderOrder>;
  /**
  Create an order for change the hosting main domain
  Get allowed durations for 'changeMainDomain' option
  **/
  public get(path: '/order/hosting/web/{serviceName}/changeMainDomain', pathParams: {serviceName?: string}, queryParams: {mxplan?: HostingWebOrderMxPlanEnum, domain?: string}): Promise<string[]>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/hosting/web/new/{duration}', pathParams: {duration?: string}, queryParams: {module?: HostingWebModuleOrderableNameEnum, waiveRetractationPeriod?: boolean, domain?: string, offer?: HostingWebOfferEnum, dnsZone?: HostingWebDnsZoneEnum}): Promise<OrderOrder>;
  /**
  Order a new hosting account
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/hosting/web/new', pathParams: null, queryParams: {module?: HostingWebModuleOrderableNameEnum, waiveRetractationPeriod?: boolean, domain?: string, offer?: HostingWebOfferEnum, dnsZone?: HostingWebDnsZoneEnum}): Promise<string[]>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/hosting/privateDatabase/new/{duration}', pathParams: {duration?: string}, queryParams: {version?: HostingPrivateDatabaseOrderableVersionEnum, offer?: HostingPrivateDatabaseOfferEnum, ram?: HostingPrivateDatabaseAvailableRamSizeEnum, datacenter?: HostingPrivateDatabaseDatacenterEnum}): Promise<OrderOrder>;
  /**
  Order new private database
  Get allowed durations for 'new' option
  **/
  public get(path: '/order/hosting/privateDatabase/new', pathParams: null, queryParams: {version?: HostingPrivateDatabaseOrderableVersionEnum, offer?: HostingPrivateDatabaseOfferEnum, ram?: HostingPrivateDatabaseAvailableRamSizeEnum, datacenter?: HostingPrivateDatabaseDatacenterEnum}): Promise<string[]>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/dedicatedCloud/{serviceName}/ip/{duration}', pathParams: {serviceName?: string, duration?: string}, queryParams: {usage?: string, size?: DedicatedCloudOrderableIpBlockRangeEnum, country?: DedicatedCloudIpCountriesEnum, networkName?: string, estimatedClientsNumber?: Number, description?: string}): Promise<OrderOrder>;
  /**
  Order an IP block for your Private Cloud
  Get allowed durations for 'ip' option
  **/
  public get(path: '/order/dedicatedCloud/{serviceName}/ip', pathParams: {serviceName?: string}, queryParams: {usage?: string, size?: DedicatedCloudOrderableIpBlockRangeEnum, country?: DedicatedCloudIpCountriesEnum, networkName?: string, estimatedClientsNumber?: Number, description?: string}): Promise<string[]>;
  /**
  ...
  **/
  public get(path: '/order/dedicatedCloud/{serviceName}/upgradeRessource', pathParams: {serviceName?: string}, queryParams: {upgradedRessourceId?: Number, upgradeType?: DedicatedCloudRessourcesUpgradeTypeEnum, upgradedRessourceType?: DedicatedCloudRessourcesUpgradeRessourceTypeEnum}): Promise<string[]>;
  /**
  Upgrade ressources billing type. For hourlyToMonthly, already consumed hours will be billed at the end of the month
  Get prices and contracts information
  **/
  public get(path: '/order/dedicatedCloud/{serviceName}/upgradeRessource/{duration}', pathParams: {serviceName?: string, duration?: string}, queryParams: {upgradedRessourceId?: Number, upgradeType?: DedicatedCloudRessourcesUpgradeTypeEnum, upgradedRessourceType?: DedicatedCloudRessourcesUpgradeRessourceTypeEnum}): Promise<OrderOrder>;
  /**
  ...
  **/
  ...
  Get prices and contracts information
  **/
  public get(path: '/order/xdsl/spare/new', pathParams: null, queryParams: {mondialRelayId?: string, brand?: string, quantity?: Number, shippingContactId?: Number}): Promise<OrderOrder>;
  /**
  List available options for this service
  Get allowed options
  **/
  ...
  **/
  public put(path: '/order/cart/{cartId}/item/{itemId}', pathParams: {cartId?: string, itemId?: Number}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Modify information about a specific cart
  **/
  public put(path: '/order/cart/{cartId}', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartCart>;
  public put(path: PathsorderPUT, pathParams?: any, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  Order an upgrade upon your Veeam Cloud Connect account
  Create order
  **/
  public post(path: '/order/veeamCloudConnect/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for a new office tenant
  Create order
  **/
  public post(path: '/order/saas/csp2/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Missing description
  Create a new OVH order cart
  **/
  public post(path: '/order/cart', pathParams: null, bodyParams: null): Promise<OrderCartCart>;
  /**
  Missing description
  Post a new Worklight license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licenseWorklight', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud CDI item in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudCDI', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud CDI option in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudCDI/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new CloudLinux license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licenseCloudLinux', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud Dedicated Cloud item in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudDC', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud Dedicated Cloud option in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudDC/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Directadmin license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licenseDirectadmin', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SaaS CSP2 option in your cart
  **/
  public post(path: '/order/cart/{cartId}/csp2/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SaaS CSP2 offer item in your cart
  **/
  public post(path: '/order/cart/{cartId}/csp2', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new vRack item in your cart
  **/
  public post(path: '/order/cart/{cartId}/vrack', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Veeam Enterprise item in your cart
  **/
  public post(path: '/order/cart/{cartId}/veeamEnterprise', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Veeam Enterprise option in your cart
  **/
  public post(path: '/order/cart/{cartId}/veeamEnterprise/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Validate your shopping and create order
  **/
  public post(path: '/order/cart/{cartId}/checkout', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Missing description
  Post a new Hosting Reseller item in your cart
  **/
  public post(path: '/order/cart/{cartId}/hostingReseller', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new baremetal server option in your cart
  **/
  public post(path: '/order/cart/{cartId}/baremetalServers/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new baremetal server item in your cart
  **/
  public post(path: '/order/cart/{cartId}/baremetalServers', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Public Cloud option in your cart
  **/
  public post(path: '/order/cart/{cartId}/cloud/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Public Cloud item in your cart
  **/
  public post(path: '/order/cart/{cartId}/cloud', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Domain Packs item (AllDom) in your cart
  **/
  public post(path: '/order/cart/{cartId}/domainPacks', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new DNS zone item in your cart
  **/
  public post(path: '/order/cart/{cartId}/dns', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new vRack item in your cart
  **/
  public post(path: '/order/cart/{cartId}/vrackReseller', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  List of xdsl product
  Post a new xdsl item in your cart
  **/
  public post(path: '/order/cart/{cartId}/xdsl', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  List of xdsl addon
  Post a new xdsl option in your cart
  **/
  public post(path: '/order/cart/{cartId}/xdsl/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new VPS option in your cart
  **/
  public post(path: '/order/cart/{cartId}/vps/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new VPS item in your cart
  **/
  public post(path: '/order/cart/{cartId}/vps', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SSL Comodo option in your cart
  **/
  public post(path: '/order/cart/{cartId}/sslComodo/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SSL Comodo item in your cart
  **/
  public post(path: '/order/cart/{cartId}/sslComodo', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Horizon View item in your cart
  **/
  public post(path: '/order/cart/{cartId}/vdi', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Horizon View option in your cart
  **/
  public post(path: '/order/cart/{cartId}/vdi/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Office 365 Prepaid item in your cart
  **/
  public post(path: '/order/cart/{cartId}/office365Prepaid', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Office 365 Prepaid option in your cart
  **/
  public post(path: '/order/cart/{cartId}/office365Prepaid/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new dedicated server item in your cart
  **/
  public post(path: '/order/cart/{cartId}/dedicatedReseller', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new dedicated server option in your cart
  **/
  public post(path: '/order/cart/{cartId}/dedicatedReseller/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Exchange Enterprise option in your cart
  **/
  public post(path: '/order/cart/{cartId}/exchangeEnterprise/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Exchange Enterprise item in your cart
  **/
  public post(path: '/order/cart/{cartId}/exchangeEnterprise', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Metrics item in your cart
  **/
  public post(path: '/order/cart/{cartId}/metrics', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Metrics option in your cart
  **/
  public post(path: '/order/cart/{cartId}/metrics/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new dedicated server option in your cart
  **/
  public post(path: '/order/cart/{cartId}/dedicated/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new dedicated server item in your cart
  **/
  public post(path: '/order/cart/{cartId}/dedicated', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new IP Load-Balancing item in your cart
  **/
  public post(path: '/order/cart/{cartId}/ipLoadbalancing', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new IP Load-Balancing option in your cart
  **/
  public post(path: '/order/cart/{cartId}/ipLoadbalancing/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Sharepoint offer item in your cart
  **/
  public post(path: '/order/cart/{cartId}/sharepoint', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Sharepoint option in your cart
  **/
  public post(path: '/order/cart/{cartId}/sharepoint/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Over The Box item in your cart
  **/
  public post(path: '/order/cart/{cartId}/otb', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Over The Box option in your cart
  **/
  public post(path: '/order/cart/{cartId}/otb/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Desk as a service item in your cart
  **/
  public post(path: '/order/cart/{cartId}/deskaas', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Add a new coupon to cart
  **/
  public post(path: '/order/cart/{cartId}/coupon', pathParams: {cartId?: string}, bodyParams: null): Promise<string[]>;
  /**
  Missing description
  Post a new Exchange option in your cart
  **/
  public post(path: '/order/cart/{cartId}/exchange/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Exchange item in your cart
  **/
  public post(path: '/order/cart/{cartId}/exchange', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new domain in your cart
  **/
  public post(path: '/order/cart/{cartId}/domain', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new domain name option in your cart
  **/
  public post(path: '/order/cart/{cartId}/domain/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Ceph as a Service option in your cart
  **/
  public post(path: '/order/cart/{cartId}/cephaas/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Ceph as a Service item in your cart
  **/
  public post(path: '/order/cart/{cartId}/cephaas', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SqlServer license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licenseSqlServer', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Reseller offer item in your cart
  **/
  public post(path: '/order/cart/{cartId}/reseller', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new NAS HA item in your cart
  **/
  public post(path: '/order/cart/{cartId}/nasha', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new NAS HA option in your cart
  **/
  public post(path: '/order/cart/{cartId}/nasha/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new timeseries offer item in your cart
  **/
  public post(path: '/order/cart/{cartId}/dbaasTimeseries', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Setup configuration item for the product
  **/
  public post(path: '/order/cart/{cartId}/item/{itemId}/configuration', pathParams: {cartId?: string, itemId?: Number}, bodyParams: null): Promise<OrderCartConfigurationItem>;
  /**
  Missing description
  Post a new Private Cloud Reseller Enterprise option in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudResellerEnterprise/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud Reseller Enterprise item in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudResellerEnterprise', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Assign a shopping cart to an loggedin client
  **/
  public post(path: '/order/cart/{cartId}/assign', pathParams: {cartId?: string}, bodyParams: null): Promise<void>;
  /**
  Missing description
  Post a new Managed Services option in your cart
  **/
  public post(path: '/order/cart/{cartId}/managedServices/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Managed Services item in your cart
  **/
  public post(path: '/order/cart/{cartId}/managedServices', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud Reseller item in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudReseller', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud Reseller option in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudReseller/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new PaaS Monitoring item in your cart
  **/
  public post(path: '/order/cart/{cartId}/paasmon', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Veeam Cloud Connect item in your cart
  **/
  public post(path: '/order/cart/{cartId}/veeamcc', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Veeam Cloud Connect option in your cart
  **/
  public post(path: '/order/cart/{cartId}/veeamcc/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Windows license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licenseWindows', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  List of OVHcloud Connect product
  Post a new OVHcloud Connect item in your cart
  **/
  public post(path: '/order/cart/{cartId}/vco', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Kubernetes item in your cart
  **/
  public post(path: '/order/cart/{cartId}/kubernetes', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Kubernetes option in your cart
  **/
  public post(path: '/order/cart/{cartId}/kubernetes/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new CDN item in your cart
  **/
  public post(path: '/order/cart/{cartId}/cdn', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new CDN option in your cart
  **/
  public post(path: '/order/cart/{cartId}/cdn/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SSL Gateway item in your cart
  **/
  public post(path: '/order/cart/{cartId}/sslGateway', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SSL Gateway option in your cart
  **/
  public post(path: '/order/cart/{cartId}/sslGateway/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Logs item in your cart
  **/
  public post(path: '/order/cart/{cartId}/logs', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Logs option in your cart
  **/
  public post(path: '/order/cart/{cartId}/logs/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new webHosting item in your cart
  **/
  public post(path: '/order/cart/{cartId}/webHosting', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new webHosting option in your cart
  **/
  public post(path: '/order/cart/{cartId}/webHosting/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new IP addresses option in your cart
  **/
  public post(path: '/order/cart/{cartId}/ip/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new IP addresses item in your cart
  **/
  public post(path: '/order/cart/{cartId}/ip', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Dedicated Discover server option in your cart
  **/
  public post(path: '/order/cart/{cartId}/discover/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Dedicated Discover server item in your cart
  **/
  public post(path: '/order/cart/{cartId}/discover', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Microsoft offer item in your cart
  **/
  public post(path: '/order/cart/{cartId}/microsoft', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Microsoft option in your cart
  **/
  public post(path: '/order/cart/{cartId}/microsoft/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new domain tranfer in your cart
  **/
  public post(path: '/order/cart/{cartId}/domainTransfer', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new domain name transfer option in your cart
  **/
  public post(path: '/order/cart/{cartId}/domainTransfer/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Cloud Web item in your cart
  **/
  public post(path: '/order/cart/{cartId}/cloudweb', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Cloud Web option in your cart
  **/
  public post(path: '/order/cart/{cartId}/cloudweb/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new VoIP item in your cart
  **/
  public post(path: '/order/cart/{cartId}/telephony', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new VoIP option in your cart
  **/
  public post(path: '/order/cart/{cartId}/telephony/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new dedicated labs server item in your cart
  **/
  public post(path: '/order/cart/{cartId}/dedicatedLabs', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new dedicated labs server option in your cart
  **/
  public post(path: '/order/cart/{cartId}/dedicatedLabs/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Office 365 item in your cart
  **/
  public post(path: '/order/cart/{cartId}/office365', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Office 365 option in your cart
  **/
  public post(path: '/order/cart/{cartId}/office365/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new SMS item in your cart
  **/
  public post(path: '/order/cart/{cartId}/sms', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new EmailPro item in your cart
  **/
  public post(path: '/order/cart/{cartId}/emailpro', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new EmailPro option in your cart
  **/
  public post(path: '/order/cart/{cartId}/emailpro/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new cPanel license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licensecPanel', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud SDDC option in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudSDDC/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Private Cloud SDDC item in your cart
  **/
  public post(path: '/order/cart/{cartId}/privateCloudSDDC', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Virtuozzo license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licenseVirtuozzo', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Plesk license option in your cart
  **/
  public post(path: '/order/cart/{cartId}/licensePlesk/options', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Missing description
  Post a new Plesk license item in your cart
  **/
  public post(path: '/order/cart/{cartId}/licensePlesk', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  List of OVHcloud Connect product
  Post a new OVHcloud Connect item in your cart
  **/
  public post(path: '/order/cart/{cartId}/ovhCloudConnect', pathParams: {cartId?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Order a new Nas HA
  Create order
  **/
  public post(path: '/order/dedicated/nasha/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order an APC for this bay
  Create order
  **/
  public post(path: '/order/dedicated/housing/{serviceName}/APC/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a kvmip express for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/kvmExpress/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order professional use option
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/professionalUse/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a feature for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/feature/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order IP for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/ip/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Migrate an IP from So you Start to OVH server, this operation is one-way only and can't be reverted
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/ipMigration/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order vRack bandwidth for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/bandwidthvRack/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a backup storage for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/backupStorage/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a static IP for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/staticIP/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a kvm for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/kvm/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a failover IP for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/failoverIP/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order bandwidth for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/bandwidth/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order an USB key for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/usbKey/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order additionall traffic for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/traffic/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  order a Firewall for this server
  Create order
  **/
  public post(path: '/order/dedicated/server/{serviceName}/firewall/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order to upgrade your overTheBox service
  Create order
  **/
  public post(path: '/order/overTheBox/{serviceName}/migrate', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Subscribe to overTheBox service
  Create order
  **/
  public post(path: '/order/overTheBox/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order router vpn
  Create order
  **/
  public post(path: '/order/router/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase a new standard alias number
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/numberGeographic', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase a new standard alias number
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/numberNogeographic', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new portability
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/portability', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase a new line offer
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/line', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase new accessories
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/accessories', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase a new standard alias number
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/numberSpecial', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Credit security deposit
  Create order
  **/
  public post(path: '/order/telephony/{billingAccount}/securityDeposit', pathParams: {billingAccount?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Update extra simultaneous channels for a specifical service to the requested amount
  Create order
  **/
  public post(path: '/order/telephony/trunks/{serviceName}/updateSimultaneousChannels', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Add extra simultaneous lines for a specifical line
  Create order
  **/
  public post(path: '/order/telephony/trunks/{serviceName}/addSimultaneousLines', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a phone for this specific line
  Create order
  **/
  public post(path: '/order/telephony/trunks/{serviceName}/hardware', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase a new billing account
  Create order
  **/
  public post(path: '/order/telephony/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  /**
  Purchase spare phone
  Create order
  **/
  public post(path: '/order/telephony/spare/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  /**
  Add extra simultaneous lines for a specifical line
  Create order
  **/
  public post(path: '/order/telephony/lines/{serviceName}/addSimultaneousLines', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Update extra simultaneous channels for a specifical service to the requested amount
  Create order
  **/
  public post(path: '/order/telephony/lines/{serviceName}/updateSimultaneousChannels', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a phone for this specific line
  Create order
  **/
  public post(path: '/order/telephony/lines/{serviceName}/hardware', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order new vrack
  Create order
  **/
  public post(path: '/order/vrack/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  /**
  Listing offers /order/upgrade/baremetalPrivateBandwidth/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/baremetalPrivateBandwidth/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/cephaas/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/cephaas/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/metrics/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/metrics/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/ipLoadbalancing/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/ipLoadbalancing/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/sslGateway/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/sslGateway/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/logs/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/logs/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/microsoftExchange/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/microsoftExchange/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/baremetalPublicBandwidth/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/baremetalPublicBandwidth/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Listing offers /order/upgrade/privateCloud/#serviceName#
  Perform the requested upgrade of your service
  **/
  public post(path: '/order/upgrade/privateCloud/{serviceName}/{planCode}', pathParams: {planCode?: string, serviceName?: string}, bodyParams: null): Promise<OrderUpgradeOperationAndOrder>;
  /**
  Order a HPC Spot Account
  Create order
  **/
  public post(path: '/order/hpcspot/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/plesk/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade this license with some given options
  Create order
  **/
  public post(path: '/order/license/plesk/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for an new office tenant
  Create order
  **/
  public post(path: '/order/license/office/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade this license with some given options
  Create order
  **/
  public post(path: '/order/license/worklight/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/worklight/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/cpanel/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade this license with some given options
  Create order
  **/
  public post(path: '/order/license/virtuozzo/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/virtuozzo/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/directadmin/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/windows/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade this license with some given options
  Create order
  **/
  public post(path: '/order/license/windows/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/sqlserver/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade this license with some given options
  Create order
  **/
  public post(path: '/order/license/sqlserver/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new license on a given Ip with some given options
  Create order
  **/
  public post(path: '/order/license/cloudLinux/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order credits on an existing SMS account
  Create order
  **/
  public post(path: '/order/sms/{serviceName}/credits', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create and credit a new SMS Account
  Create order
  **/
  public post(path: '/order/sms/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Anycast
  Create order
  **/
  public post(path: '/order/domain/zone/{zoneName}/dnsAnycast/{duration}', pathParams: {zoneName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new DNS zone
  Create order
  **/
  public post(path: '/order/domain/zone/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for hosted ssl option
  Create order
  **/
  public post(path: '/order/hosting/web/{serviceName}/ssl/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for cdn option
  Create order
  **/
  public post(path: '/order/hosting/web/{serviceName}/cdn/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for upgrade your hosting account
  Create order
  **/
  public post(path: '/order/hosting/web/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for extra sql perso
  Create order
  **/
  public post(path: '/order/hosting/web/{serviceName}/extraSqlPerso/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for change the hosting main domain
  Create order
  **/
  public post(path: '/order/hosting/web/{serviceName}/changeMainDomain/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order additional bandwidth
  Create order
  **/
  public post(path: '/order/hosting/web/{serviceName}/bandwidth/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new hosting account
  Create order
  **/
  public post(path: '/order/hosting/web/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order new private database
  Create order
  **/
  public post(path: '/order/hosting/privateDatabase/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for change ram size on your private database
  Create order
  **/
  public post(path: '/order/hosting/privateDatabase/{serviceName}/ram/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order additional bandwidth in your Private Cloud
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/additionalBandwidth/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Enable windows templates (SPLA) in your Private Cloud
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/spla', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order an IP block for your Private Cloud
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/ip/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new Host in a given Datacenter  (orderable hosts are given by /dedicatedCloud/{serviceName}/datacenter/{datacenterId}/orderableHostProfiles)
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/host/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order VDI option in a given Datacenter
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/vdi', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade ressources billing type. For hourlyToMonthly, already consumed hours will be billed at the end of the month
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/upgradeRessource/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new Filer in a given Datacenter (available filers are given in /dedicatedCloud/{serviceName}/datacenter/{datacenterId}/orderableFilerProfiles)
  Create order
  **/
  public post(path: '/order/dedicatedCloud/{serviceName}/filer/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Automated Backup Option (vps Cloud only)
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/automatedBackup/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Veeam Option
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/veeam/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Snapshot Option
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/snapshot/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for a cPanel license
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/cpanel/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for a PLESK license
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/plesk/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Upgrade
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/upgrade/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order FtpBackup Option
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/ftpbackup/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Additional IP
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/ip/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Windows Option (2015 only)
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/windows/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order additional disk
  Create order
  **/
  public post(path: '/order/vps/{serviceName}/additionalDisk/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Backend Option
  Create order
  **/
  public post(path: '/order/cdn/dedicated/{serviceName}/backend/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Quota
  Create order
  **/
  public post(path: '/order/cdn/dedicated/{serviceName}/quota/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade cacheRule Option
  Create order
  **/
  public post(path: '/order/cdn/dedicated/{serviceName}/cacheRule/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a New Dedicated CDN Service
  Create order
  **/
  public post(path: '/order/cdn/dedicated/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order Traffic
  Create order
  **/
  public post(path: '/order/cdn/webstorage/{serviceName}/traffic', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade Storage Option
  Create order
  **/
  public post(path: '/order/cdn/webstorage/{serviceName}/storage/{duration}', pathParams: {serviceName?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order credit usable on your Cloud project
  Create order
  **/
  public post(path: '/order/cloud/project/{serviceName}/credit', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order failover ip on your Cloud project
  Create order
  **/
  public post(path: '/order/cloud/project/{serviceName}/ip', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Order a new mx plan
  Create order
  **/
  public post(path: '/order/email/domain/new/{duration}', pathParams: {duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for a additional 50GB of space (Exchange 2010 reseller only)
  Create order
  **/
  public post(path: '/order/email/exchange/{organizationName}/service/{exchangeService}/diskSpace', pathParams: {organizationName?: string, exchangeService?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for a outlook licence.
  Create order
  **/
  public post(path: '/order/email/exchange/{organizationName}/service/{exchangeService}/outlook/{duration}', pathParams: {organizationName?: string, exchangeService?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Upgrade infrustruction to newest offer (Exchange 2013 to Exchange 2016)
  Create order
  **/
  public post(path: '/order/email/exchange/{organizationName}/service/{exchangeService}/upgrade', pathParams: {organizationName?: string, exchangeService?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for an exchange account
  Create order
  **/
  public post(path: '/order/email/exchange/{organizationName}/service/{exchangeService}/account/{duration}', pathParams: {organizationName?: string, exchangeService?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order to upgrade your hosted account storage
  Create order
  **/
  public post(path: '/order/email/exchange/{organizationName}/service/{exchangeService}/accountUpgrade/{duration}', pathParams: {organizationName?: string, exchangeService?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Create an order for a pro account
  Create order
  **/
  public post(path: '/order/email/pro/{service}/account/{duration}', pathParams: {service?: string, duration?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Listing offers /order/cartServiceOptions/privateCloud/#serviceName#
  Post an additional Private Cloud option in your cart
  **/
  public post(path: '/order/cartServiceOption/privateCloud/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/microsoftExchange/#serviceName#
  Post an additional Microsoft option in your cart
  **/
  public post(path: '/order/cartServiceOption/microsoftExchange/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/sharepoint/#serviceName#
  Post an additional Sharepoint option in your cart
  **/
  public post(path: '/order/cartServiceOption/sharepoint/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/privateCloudReseller/#serviceName#
  Post an additional Private Cloud option in your cart
  **/
  public post(path: '/order/cartServiceOption/privateCloudReseller/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/microsoft/#serviceName#
  Post an additional Microsoft option in your cart
  **/
  public post(path: '/order/cartServiceOption/microsoft/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/ipLoadbalancing/#serviceName#
  Post an additional IP Load-Balancing option in your cart
  **/
  public post(path: '/order/cartServiceOption/ipLoadbalancing/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/dedicated/#serviceName#
  Post an additional dedicated option in your cart
  **/
  public post(path: '/order/cartServiceOption/dedicated/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/privateCloudResellerEnterprise/#serviceName#
  Post an additional Private Cloud Enterprise option in your cart
  **/
  public post(path: '/order/cartServiceOption/privateCloudResellerEnterprise/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/vdi/#serviceName#
  Post an additional Horizon View option in your cart
  **/
  public post(path: '/order/cartServiceOption/vdi/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/office365/#serviceName#
  Post an additional Office option in your cart
  **/
  public post(path: '/order/cartServiceOption/office365Prepaid/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/logs/#serviceName#
  Post an additional Logs option in your cart
  **/
  public post(path: '/order/cartServiceOption/logs/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/webHosting/#serviceName#
  Post an additional Web Hosting option in your cart
  **/
  public post(path: '/order/cartServiceOption/webHosting/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/cloud/#serviceName#
  Post an additional Cloud option in your cart
  **/
  public post(path: '/order/cartServiceOption/cloud/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/sslGateway/#serviceName#
  Post an additional SSL Gateway option in your cart
  **/
  public post(path: '/order/cartServiceOption/sslGateway/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/domain/#serviceName#
  Post an additional Domain option in your cart
  **/
  public post(path: '/order/cartServiceOption/domain/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Listing offers /order/cartServiceOptions/emailpro/#serviceName#
  Post an additional EmailPro option in your cart
  **/
  public post(path: '/order/cartServiceOption/emailpro/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderCartItem>;
  /**
  Purchase spare modem
  Create order
  **/
  public post(path: '/order/xdsl/spare/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  /**
  Convert the freefax service to a /telephony voicefax service
  Create order
  **/
  public post(path: '/order/freefax/{serviceName}/convertToVoicefax', pathParams: {serviceName?: string}, bodyParams: null): Promise<OrderOrder>;
  /**
  Credit freefax account pages
  Create order
  **/
  public post(path: '/order/freefax/new', pathParams: null, bodyParams: null): Promise<OrderOrder>;
  public post(path: PathsorderPOST, pathParams?: any, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  Missing description
  ...
  **/
  public delete(path: '/order/cart/{cartId}/item/{itemId}', pathParams: {cartId?: string, itemId?: Number}, bodyParams: null): Promise<void>;
  /**
  Missing description
  Delete configuration item
  **/
  public delete(path: '/order/cart/{cartId}/item/{itemId}/configuration/{configurationId}', pathParams: {cartId?: string, itemId?: Number, configurationId?: Number}, bodyParams: null): Promise<void>;
  /**
  Missing description
  Delete a cart
  **/
  public delete(path: '/order/cart/{cartId}', pathParams: {cartId?: string}, bodyParams: null): Promise<void>;
  public delete(path: PathsorderDELETE, pathParams?: any, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
