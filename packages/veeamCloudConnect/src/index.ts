...
type PathsveeamCloudConnectGET = '/veeamCloudConnect/{serviceName}/capabilities' | 
...
class ApiveeamCloudConnect extends ApiCommon {
  ...
  **/
  public get(path: '/veeamCloudConnect/{serviceName}/task', pathParams: {serviceName?: string}, queryParams: {state?: VeeamCloudConnectTaskStateEnum, name?: string}): Promise<Number[]>;
  /**
  Details about a Service
  Get this object properties
  **/
  ...
  **/
  public put(path: '/veeamCloudConnect/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathsveeamCloudConnectPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  List the veeamCloudConnect.BackupRepository objects
  Add a new Backup Repository to your professional account
  **/
  public post(path: '/veeamCloudConnect/{serviceName}/backupRepository', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<VeeamCloudConnectTask[]>;
  /**
  upgradeQuota operations
  Change your quota
  **/
  public post(path: '/veeamCloudConnect/{serviceName}/backupRepository/{inventoryName}/upgradeQuota', pathParams: {serviceName?: string, inventoryName?: string}, queryParams: null, bodyParams: null): Promise<VeeamCloudConnectTask[]>;
  public post(path: PathsveeamCloudConnectPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Veeam Backup Repository
  Delete this backup Repository. 
  **/
  public delete(path: '/veeamCloudConnect/{serviceName}/backupRepository/{inventoryName}', pathParams: {serviceName?: string, inventoryName?: string}, queryParams: null, bodyParams: null): Promise<VeeamCloudConnectTask[]>;
  public delete(path: PathsveeamCloudConnectDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
