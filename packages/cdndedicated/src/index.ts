...
type PathscdndedicatedPOST = '/cdn/dedicated/{serviceName}/ssl' | 
...
class Apicdndedicated extends ApiCommon {
  ...
  **/
  public get(path: '/cdn/dedicated/{serviceName}/domains/{domain}/statistics', pathParams: {serviceName?: string, domain?: string}, queryParams: {type?: CdnanycastStatsTypeEnum, period?: CdnanycastStatsPeriodEnum, value?: CdnanycastStatsValueEnum}): Promise<CdnanycastStatsDataType[]>;
  /**
  ...
  **/
  public put(path: '/cdn/dedicated/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Domain on CDN
  Alter this object properties
  **/
  public put(path: '/cdn/dedicated/{serviceName}/domains/{domain}', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  CacheRules for a domain
  Alter this object properties
  **/
  public put(path: '/cdn/dedicated/{serviceName}/domains/{domain}/cacheRules/{cacheRuleId}', pathParams: {serviceName?: string, domain?: string, cacheRuleId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathscdndedicatedPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  CDN Ssl
  Add a SSL on CDN or Generate a Lets Encrypt certificate
  **/
  public post(path: '/cdn/dedicated/{serviceName}/ssl', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastSsl>;
  /**
  update operations
  Update an existing SSL with a custom certificate
  **/
  public post(path: '/cdn/dedicated/{serviceName}/ssl/update', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastTask>;
  /**
  Change the contacts of this service
  Launch a contact change procedure
  **/
  public post(path: '/cdn/dedicated/{serviceName}/changeContact', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<Number[]>;
  /**
  List the cdnanycast.Backend objects
  Add a backend IP
  **/
  public post(path: '/cdn/dedicated/{serviceName}/domains/{domain}/backends', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastBackend>;
  /**
  flush operations
  Flush the cache
  **/
  public post(path: '/cdn/dedicated/{serviceName}/domains/{domain}/cacheRules/{cacheRuleId}/flush', pathParams: {serviceName?: string, domain?: string, cacheRuleId?: Number}, queryParams: null, bodyParams: null): Promise<CdnanycastTask>;
  /**
  List the cdnanycast.CacheRule objects
  Add a cache rule to a domain
  **/
  public post(path: '/cdn/dedicated/{serviceName}/domains/{domain}/cacheRules', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastCacheRule>;
  /**
  flush operations
  Flush all cache
  **/
  public post(path: '/cdn/dedicated/{serviceName}/domains/{domain}/flush', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastTask>;
  /**
  logs operations
  Generate URL to real time logs
  **/
  public post(path: '/cdn/dedicated/{serviceName}/domains/{domain}/logs', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastLogsURL>;
  /**
  List the cdnanycast.Domain objects
  Add a domain on CDN
  **/
  public post(path: '/cdn/dedicated/{serviceName}/domains', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastDomain>;
  /**
  logs operations
  Generate URL to real time logs
  **/
  public post(path: '/cdn/dedicated/{serviceName}/logs', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastLogsURL>;
  public post(path: PathscdndedicatedPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  CDN Ssl
  Remove SSL of the CDN
  **/
  public delete(path: '/cdn/dedicated/{serviceName}/ssl', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastTask>;
  /**
  Domain on CDN
  Remove a domain from the CDN
  **/
  public delete(path: '/cdn/dedicated/{serviceName}/domains/{domain}', pathParams: {serviceName?: string, domain?: string}, queryParams: null, bodyParams: null): Promise<CdnanycastTask>;
  /**
  Backend for a domain
  Remove a backend IP
  **/
  public delete(path: '/cdn/dedicated/{serviceName}/domains/{domain}/backends/{ip}', pathParams: {serviceName?: string, domain?: string, ip?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  CacheRules for a domain
  Remove cache rule
  **/
  public delete(path: '/cdn/dedicated/{serviceName}/domains/{domain}/cacheRules/{cacheRuleId}', pathParams: {serviceName?: string, domain?: string, cacheRuleId?: Number}, queryParams: null, bodyParams: null): Promise<CdnanycastTask>;
  public delete(path: PathscdndedicatedDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
