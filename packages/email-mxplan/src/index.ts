...
export class ApiEmailMxplan extends ApiCommon {
  ...
  **/
  ...
  public delete(path: PathsEmailMxplanDELETE, pathParams?: { [key:string]: string | Number; }, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
