...
type PathsEmaildomainPUT = '/email/domain/{domain}/account/{accountName}' | 
'/email/domain/{domain}/responder/{account}' | 
'/email/domain/{domain}/serviceInfos' | 
'/email/domain/{domain}/mailingList/{name}' | 
'/email/domain/delegatedAccount/{email}/responder' | 
...
type PathsEmaildomainPOST = '/email/domain/{domain}/changeContact' | 
...
type PathsEmaildomainDELETE = '/email/domain/{domain}/account/{accountName}/delegation/{accountId}' | 
'/email/domain/{domain}/account/{accountName}/filter/{name}/rule/{id}' | 
'/email/domain/{domain}/account/{accountName}/filter/{name}' | 
'/email/domain/{domain}/account/{accountName}' | 
'/email/domain/{domain}/responder/{account}' | 
...
export class ApiEmaildomain extends ApiCommon {
  ...
  **/
  ...
  Get delegations
  **/
  public get(path: '/email/domain/{domain}/account/{accountName}/delegation', pathParams: {domain: string, accountName: string}): Promise<coreTypes.AccountId[]:string[]>;
  /**
  Delegation List
  Get this object properties
  **/
  ...
  **/
  public get(path: '/email/domain/{domain}/acl', pathParams: {domain: string}): Promise<coreTypes.AccountId[]:string[]>;
  /**
  Email ACL
  Get this object properties
  **/
  ...
  **/
  ...
  Delegated emails
  **/
  public get(path: '/email/domain/delegatedAccount', pathParams: null, queryParams: {domain?: string, accountName?: string}): Promise<string[]>;
  public get(path: PathsEmaildomainGET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Account List
  ...
  **/
  ...
  public put(path: PathsEmaildomainPUT, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  ...
  **/
  ...
  public post(path: PathsEmaildomainPOST, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  Delegation List
  ...
  **/
  ...
  public delete(path: PathsEmaildomainDELETE, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
