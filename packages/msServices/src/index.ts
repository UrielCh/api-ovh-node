...
export class ApiMsServices extends ApiCommon {
  ...
  **/
  ...
  Pending actions
  **/
  public get(path: '/msServices/{serviceName}/sharepoint/task', pathParams: {serviceName: string}, queryParams: {status?: MsServicesTaskStatusEnum, function?: string}): Promise<Number[]>;
  /**
  Sharepoint task details
  Get this object properties
  **/
  ...
  **/
  ...
  Get active licenses for specific period of time
  **/
  public get(path: '/msServices/{serviceName}/sync/license', pathParams: {serviceName: string}, queryParams: {period?: MsServicesLicensePeriodEnum, license?: MsServicesSyncLicenseEnum}): Promise<MsServicesSyncDailyLicense[]>;
  /**
  Operations about the MSSERVICES service
  List available services
  **/
  public get(path: '/msServices'): Promise<string[]>;
  public get(path: PathsMsServicesGET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Details about a Service
  ...
  **/
  ...
  public put(path: PathsMsServicesPUT, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  ...
  **/
  ...
  public post(path: PathsMsServicesPOST, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  Sync account information
  Delete sync account
  **/
  ...
  **/
  ...
  public delete(path: PathsMsServicesDELETE, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
