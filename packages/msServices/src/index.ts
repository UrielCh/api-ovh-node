...
type PathsmsServicesPUT = '/msServices/{serviceName}/sharepoint' | 
'/msServices/{serviceName}/exchange' | 
'/msServices/{serviceName}' | 
'/msServices/{serviceName}/account/{userPrincipalName}/exchange' | 
'/msServices/{serviceName}/account/{userPrincipalName}' | 
...
type PathsmsServicesPOST = '/msServices/{serviceName}/sharepoint/restoreAdminRights' | 
'/msServices/{serviceName}/upnSuffix' | 
'/msServices/{serviceName}/sync/clientSoftwareURL' | 
...
class ApimsServices extends ApiCommon {
  ...
  **/
  public put(path: '/msServices/{serviceName}/sharepoint', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Exchange service
  Alter this object properties
  **/
  public put(path: '/msServices/{serviceName}/exchange', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Active Directory organizational unit
  Alter this object properties
  **/
  public put(path: '/msServices/{serviceName}', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Exchange mailbox information
  Alter this object properties
  **/
  public put(path: '/msServices/{serviceName}/account/{userPrincipalName}/exchange', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Active Directory Account
  Alter this object properties
  **/
  public put(path: '/msServices/{serviceName}/account/{userPrincipalName}', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Sharepoint account information
  Alter this object properties
  **/
  public put(path: '/msServices/{serviceName}/account/{userPrincipalName}/sharepoint', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Details about a Service
  Alter this object properties
  **/
  public put(path: '/msServices/sharepoint/{domain}/serviceInfos', pathParams: {domain?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathsmsServicesPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  restoreAdminRights operations
  Restore administrator rights
  **/
  public post(path: '/msServices/{serviceName}/sharepoint/restoreAdminRights', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesSharepointTask>;
  /**
  List the msServices.upnSuffix objects
  Create new UPN suffix
  **/
  public post(path: '/msServices/{serviceName}/upnSuffix', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  Temporary link to ADSync software executable
  Generate temporary link to ADSync software executable
  **/
  public post(path: '/msServices/{serviceName}/sync/clientSoftwareURL', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  changePassword operations
  Change account password
  **/
  public post(path: '/msServices/{serviceName}/sync/changePassword', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  configure operations
  Configure mailbox to be operational
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/exchange/configure', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesExchangeTask>;
  /**
  configure operations
  Configure sync account to be operational
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/sync/configure', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  Sync account information
  Create new sync account
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/sync', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  clearSpace operations
  On-demand MySite clearance
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/sharepoint/clearSpace', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesSharepointTask>;
  /**
  configure operations
  Configure sharepoint account to be operational
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/sharepoint/configure', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesSharepointTask>;
  /**
  Multi Factor Authentication informations
  Create Multi Factor Authentication for this account
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/mfa', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  disable operations
  Disable Multi Factor Authentication for a period of time
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/mfa/disable', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  enable operations
  Enable Mfa (enabled by default when created)
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/mfa/enable', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  reset operations
  Reset Multi Factor Authentication status for this account
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/mfa/reset', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  changePassword operations
  Change account password
  **/
  public post(path: '/msServices/{serviceName}/account/{userPrincipalName}/changePassword', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  public post(path: PathsmsServicesPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Active Directory UPN Suffix
  Delete existing UPN suffix
  **/
  public delete(path: '/msServices/{serviceName}/upnSuffix/{suffix}', pathParams: {serviceName?: string, suffix?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  Sync service
  Delete sync service
  **/
  public delete(path: '/msServices/{serviceName}/sync', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  Sync account information
  Delete sync account
  **/
  public delete(path: '/msServices/{serviceName}/account/{userPrincipalName}/sync', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  /**
  Multi Factor Authentication informations
  Delete Multi Factor Authentication feature for this account
  **/
  public delete(path: '/msServices/{serviceName}/account/{userPrincipalName}/mfa', pathParams: {serviceName?: string, userPrincipalName?: string}, queryParams: null, bodyParams: null): Promise<MsServicesTask>;
  public delete(path: PathsmsServicesDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
