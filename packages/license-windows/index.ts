...
export namespace license {
    ...
    export interface OrderableWindowsCompatibilityInfos {
        compliantSql: OVH.license.WindowsSqlVersionEnum[];
        version: OVH.license.WindowsOsVersionEnum;
    }
    //license.StateEnum
    ...
    export interface WindowsOrderConfiguration {
        orderableVersions: OVH.license.OrderableWindowsCompatibilityInfos[];
...
export class ApiLicenseWindows extends OvhWrapper {
   ...
   */
  public get(path: '/license/windows/{serviceName}/tasks', params: {serviceName: string, action?: OVH.license.ActionType, status?: OVH.license.TaskStateEnum}): Promise<number[]>;
  /**
   * licenses Todos
   * Get this object properties
   */
   ...
   */
  public put(path: '/license/windows/{serviceName}', params: {serviceName: string, creation?: string, deleteAtExpiration?: boolean, domain?: string, ip?: string, licenseId?: string, status?: OVH.license.StateEnum, version?: OVH.license.WindowsOsVersionEnum}): Promise<void>;
  /**
   * Details about a Service
   * Alter this object properties
   */
  public put(path: '/license/windows/{serviceName}/serviceInfos', params: {serviceName: string, canDeleteAtExpiration?: boolean, contactAdmin?: string, contactBilling?: string, contactTech?: string, creation?: string, domain?: string, engagedUpTo?: string, expiration?: string, possibleRenewPeriod?: number[], renew?: OVH.service.RenewType, renewalType?: OVH.service.RenewalTypeEnum, serviceId?: number, status?: OVH.service.StateEnum}): Promise<void>;
   ...
   * Confirm termination of your service
   */
  public post(path: '/license/windows/{serviceName}/confirmTermination', params: {serviceName: string, commentary?: string, futureUse?: OVH.service.TerminationFutureUseEnum, reason?: OVH.service.TerminationReasonEnum, token: string}): Promise<string>;
  /**
   * sqlServer operations
   * Link your own sql server license to this Windows license
   */
  public post(path: '/license/windows/{serviceName}/sqlServer', params: {serviceName: string, licenseId: string, version: OVH.license.WindowsSqlVersionEnum}): Promise<license.Task>;
  /**
