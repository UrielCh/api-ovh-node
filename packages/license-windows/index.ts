...
export class ApiLicenseWindows extends OvhWrapper {
   ...
   */
  public get(path: '/license/windows/{serviceName}', params: {serviceName: string}): Promise<license.windows.Windows>;
  /**
   * List the license.Option objects
   * options attached to this license
   */
  public get(path: '/license/windows/{serviceName}/option', params: {serviceName: string}): Promise<license.OptionLabel[]>;
  /**
   * Your License options
   * Get this object properties
   */
  public get(path: '/license/windows/{serviceName}/option/{label}', params: {label: license.OptionLabel, serviceName: string}): Promise<license.Option>;
  /**
   * Details about a Service
   * Get this object properties
   */
  public get(path: '/license/windows/{serviceName}/serviceInfos', params: {serviceName: string}): Promise<services.Service>;
  /**
   * List the license.Task objects
   * tasks linked to this license
   */
  public get(path: '/license/windows/{serviceName}/tasks', params: {serviceName: string, action?: license.ActionType, status?: license.TaskStateEnum}): Promise<number[]>;
  /**
   * licenses Todos
   * Get this object properties
   */
   ...
   * Get the orderable Windows versions
   */
  public get(path: '/license/windows/orderableVersions', params: {ip: string}): Promise<license.WindowsOrderConfiguration[]>;
   ...
   */
  public put(path: '/license/windows/{serviceName}', params: {serviceName: string, creation?: string, deleteAtExpiration?: boolean, domain?: string, ip?: string, licenseId?: string, status?: license.StateEnum, version?: license.WindowsOsVersionEnum}): Promise<void>;
  /**
   * Details about a Service
   * Alter this object properties
   */
  public put(path: '/license/windows/{serviceName}/serviceInfos', params: {serviceName: string, canDeleteAtExpiration?: boolean, contactAdmin?: string, contactBilling?: string, contactTech?: string, creation?: string, domain?: string, engagedUpTo?: string, expiration?: string, possibleRenewPeriod?: number[], renew?: service.RenewType, renewalType?: service.RenewalTypeEnum, serviceId?: number, status?: service.StateEnum}): Promise<void>;
   ...
   * Confirm termination of your service
   */
  public post(path: '/license/windows/{serviceName}/confirmTermination', params: {serviceName: string, commentary?: string, futureUse?: service.TerminationFutureUseEnum, reason?: service.TerminationReasonEnum, token: string}): Promise<string>;
  /**
   * sqlServer operations
   * Link your own sql server license to this Windows license
   */
  public post(path: '/license/windows/{serviceName}/sqlServer', params: {serviceName: string, licenseId: string, version: license.WindowsSqlVersionEnum}): Promise<license.Task>;
  /**
   ...
   * release this Option
   */
  public delete(path: '/license/windows/{serviceName}/option/{label}', params: {label: license.OptionLabel, serviceName: string}): Promise<license.Task>;
