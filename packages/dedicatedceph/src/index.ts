...
type PathsDedicatedcephPUT = '/dedicated/ceph/{serviceName}/serviceInfos' | 
'/dedicated/ceph/{serviceName}/user/{userName}/pool' | 
'/dedicated/ceph/{serviceName}';

type PathsDedicatedcephPOST = '/dedicated/ceph/{serviceName}/confirmTermination' | 
...
export class ApiDedicatedceph extends ApiCommon {
  ...
  **/
  ...
  public get(path: PathsDedicatedcephGET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Details about a Service
  ...
  **/
  ...
  public put(path: PathsDedicatedcephPUT, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  ...
  **/
  ...
  public post(path: PathsDedicatedcephPOST, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  dedicated.ceph.userDelete
  ...
  **/
  ...
  public delete(path: PathsDedicatedcephDELETE, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
