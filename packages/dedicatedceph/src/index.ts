...
type PathsdedicatedcephPOST = '/dedicated/ceph/{serviceName}/pool' | 
'/dedicated/ceph/{serviceName}/acl' | 
...
type PathsdedicatedcephDELETE = '/dedicated/ceph/{serviceName}/pool/{poolName}' | 
'/dedicated/ceph/{serviceName}/acl/{aclId}' | 
'/dedicated/ceph/{serviceName}/user/{userName}' | 
...
class Apidedicatedceph extends ApiCommon {
  ...
  **/
  public put(path: '/dedicated/ceph/{serviceName}', pathParams: {serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.userPoolPermList
  Update user-pool permission for single pool
  **/
  public put(path: '/dedicated/ceph/{serviceName}/user/{userName}/pool', pathParams: {userName?: string, serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  Details about a Service
  Alter this object properties
  **/
  public put(path: '/dedicated/ceph/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, bodyParams: null): Promise<void>;
  public put(path: PathsdedicatedcephPUT, pathParams?: any, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  dedicated.ceph.poolCreate
  Create a new ceph pool
  **/
  public post(path: '/dedicated/ceph/{serviceName}/pool', pathParams: {serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.aclCreate
  Create one or more new IP ACLs
  **/
  public post(path: '/dedicated/ceph/{serviceName}/acl', pathParams: {serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  Confirm termination of your service
  Confirm termination of your service
  **/
  public post(path: '/dedicated/ceph/{serviceName}/confirmTermination', pathParams: {serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  Terminate your service
  Terminate your service
  **/
  public post(path: '/dedicated/ceph/{serviceName}/terminate', pathParams: {serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.userCreate
  Create a new ceph user
  **/
  public post(path: '/dedicated/ceph/{serviceName}/user', pathParams: {serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.userPoolPermList
  Create new user-pool permissions. All old permissions will be cleared
  **/
  public post(path: '/dedicated/ceph/{serviceName}/user/{userName}/pool', pathParams: {userName?: string, serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  Change the contacts of this service
  Launch a contact change procedure
  **/
  public post(path: '/dedicated/ceph/{serviceName}/changeContact', pathParams: {serviceName?: string}, bodyParams: null): Promise<Number[]>;
  public post(path: PathsdedicatedcephPOST, pathParams?: any, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  dedicated.ceph.poolDelete
  Delete a single ceph pool
  **/
  public delete(path: '/dedicated/ceph/{serviceName}/pool/{poolName}', pathParams: {serviceName?: string, poolName?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.aclDeleteSingle
  Delete single IP ACL
  **/
  public delete(path: '/dedicated/ceph/{serviceName}/acl/{aclId}', pathParams: {serviceName?: string, aclId?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.userDelete
  Delete an existing single ceph user
  **/
  public delete(path: '/dedicated/ceph/{serviceName}/user/{userName}', pathParams: {userName?: string, serviceName?: string}, bodyParams: null): Promise<string>;
  /**
  dedicated.ceph.userPoolPermDelete
  Clear user-pool permission for single pool
  **/
  public delete(path: '/dedicated/ceph/{serviceName}/user/{userName}/pool/{poolName}', pathParams: {userName?: string, serviceName?: string, poolName?: string}, bodyParams: null): Promise<string>;
  public delete(path: PathsdedicatedcephDELETE, pathParams?: any, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
