...
// Api
   ...
   */
  get(path: '/license/sqlserver/{serviceName}/tasks'): (params: {serviceName: string, action?: licenseActionType, status?: licenseTaskStateEnum}) => Promise<number[]>;
  /**
   * licenses Todos
   * Get this object properties
   */
   ...
   */
  put(path: '/license/sqlserver/{serviceName}/serviceInfos'): (params: {serviceName: string, canDeleteAtExpiration?: boolean, contactAdmin?: string, contactBilling?: string, contactTech?: string, creation?: string, domain?: string, engagedUpTo?: string, expiration?: string, possibleRenewPeriod?: number[], renew?: serviceRenewType, renewalType?: serviceRenewalTypeEnum, serviceId?: number, status?: serviceStateEnum}) => Promise<void>;
  /**
 ...
 */
type licenseSqlServerVersionEnum = license.SqlServerVersionEnum;
type licenseOrderableSqlServerCompatibilityInfos = license.OrderableSqlServerCompatibilityInfos;
