...
// Api
   ...
   */
  get(path: '/partners/register/company/{companyId}'): (params: {companyId: string}) => Promise<Partner.Company>;
  /**
   * Application.create
   * Compute scoring score without submitting application
   */
  get(path: '/partners/register/company/{companyId}/application'): (params: {companyId: string}) => Promise<Partner.Application>;
  /**
   * Contact.list
   * List created contacts
   */
  get(path: '/partners/register/company/{companyId}/contact'): (params: {companyId: string}) => Promise<string[]>;
  /**
   * Contact.get
   * Get information on a created contact
   */
  get(path: '/partners/register/company/{companyId}/contact/{contactId}'): (params: {companyId: string, contactId: string}) => Promise<Partner.Contact>;
  /**
   * Company.get
   ...
   */
  put(path: '/partners/register/company/{companyId}/contact/{contactId}'): (params: {companyId: string, contactId: string, email?: string, facebook?: string, firstName?: string, lastName?: string, linkedin?: string, newsletter?: boolean, otherNics?: Partner.Nic[], phone?: string, role?: string, twitter?: string}) => Promise<Partner.Contact>;
  /**
   * Company.list
   ...
   */
  post(path: '/partners/register/company/{companyId}/application'): (params: {companyId: string, termsAndConditionsOfServiceAccepted: boolean}) => Promise<Partner.Application>;
  /**
   * Contact.list
   * Created a new contact for the inscription
   */
  post(path: '/partners/register/company/{companyId}/contact'): (params: {companyId: string, email: string, facebook?: string, firstName: string, lastName: string, linkedin?: string, newsletter?: boolean, otherNics?: Partner.Nic[], phone: string, role: string, twitter?: string}) => Promise<Partner.Contact>;
  /**
   * Company.get
   * Remove a company
   */
  delete(path: '/partners/register/company/{companyId}'): (params: {companyId: string}) => Promise<string>;
  /**
   * Contact.get
   * Remove a contact
   */
