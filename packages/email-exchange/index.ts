...
export function proxyEmailExchange(ovhEngine: OvhRequestable): Email {
    return buildOvhProxy(ovhEngine, '/email/exchange');
}
// Apis harmony
// path /email
...
export class ApiEmailExchange extends OvhWrapper {
   ...
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}', params: {exchangeService: string, organizationName: string}): Promise<email.exchange.ExchangeService>;
  /**
   ...
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Account>;
  /**
   * List the email.exchange.exchangeAccountAlias objects
   * Aliases associated to this mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/alias', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<string[]>;
  /**
   * Aliases on this mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/alias/{alias}', params: {alias: string, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountAlias>;
  /**
   * Exchange Account Archive
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/archive', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountArchive>;
  /**
   * Exchange Account Diagnosis
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/diagnostics', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountDiagnosis>;
  /**
   * Export PST file request
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/export', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Export>;
  /**
   * Export PST file url
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/exportURL', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.ExportUrl>;
  /**
   * List the email.exchange.exchangeAccountFullAccess objects
   * Full access granted users for this mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/fullAccess', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<number[]>;
  /**
   * Users having full access on this mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/fullAccess/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountFullAccess>;
  /**
   * Outlook url
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/outlookURL', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.OutlookUrl>;
  /**
   * Get protocol status on that mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/protocol', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountProtocol>;
  /**
   * List the email.exchange.exchangeAccountSendAs objects
   * Send as granted users for this mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendAs', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<number[]>;
  /**
   * Users authorized to send mails from this mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendAs/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountSendAs>;
  /**
   * List the email.exchange.exchangeAccountSendOnBehalfTo objects
   * SendOnBehalfTo granted users for this mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendOnBehalfTo', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<number[]>;
  /**
   * Get users authorized to Send On Behalf To mails from this mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendOnBehalfTo/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.exchangeAccountSendOnBehalfTo>;
  /**
   * List the email.exchange.Task objects
   * Pending task for this mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/tasks', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<number[]>;
  /**
   * Exchange task details
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/tasks/{id}', params: {exchangeService: string, id: number, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * dcvEmails operations
   * Get DCV emails if your ssl will expire in next 30 days
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/dcvEmails', params: {exchangeService: string, organizationName: string}): Promise<string[]>;
  /**
   ...
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/device/{identity}', params: {exchangeService: string, identity: string, organizationName: string}): Promise<email.exchange.exchangeServiceDevice>;
  /**
   ...
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}', params: {domainName: string, exchangeService: string, organizationName: string}): Promise<email.exchange.Domain>;
  /**
   * Exchange organization disclaimer
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}/disclaimer', params: {domainName: string, exchangeService: string, organizationName: string}): Promise<email.exchange.disclaimer>;
  /**
   * disclaimerAttribute operations
   * Get diclaimer attributes to substitute with Active Directory properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}/disclaimerAttribute', params: {domainName: string, exchangeService: string, organizationName: string}): Promise<email.exchange.DisclaimerAttributeEnum[]>;
  /**
   * List the email.exchange.exchangeExternalContact objects
   * External contacts for this service
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/externalContact', params: {exchangeService: string, organizationName: string, displayName?: string, externalEmailAddress?: string, firstName?: string, id?: number, lastName?: string}): Promise<string[]>;
  /**
   * External contact for this exchange service
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/externalContact/{externalEmailAddress}', params: {exchangeService: string, externalEmailAddress: string, organizationName: string}): Promise<email.exchange.exchangeExternalContact>;
  /**
   * license operations
   ...
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList', params: {exchangeService: string, organizationName: string, mailingListAddress?: string}): Promise<string[]>;
  /**
   * Mailing list
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.mailingList>;
  /**
   * List the email.exchange.exchangeMailingListAlias objects
   * Aliases associated to this mailingList
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/alias', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<string[]>;
  /**
   * Get aliases on this mailingList
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/alias/{alias}', params: {alias: string, exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.exchangeMailingListAlias>;
  /**
   * List the email.exchange.exchangeDistributionGroupManager objects
   * Mailing list account manager
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/manager/account', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<number[]>;
  /**
   * Mailing list managers
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/manager/account/{managerAccountId}', params: {exchangeService: string, mailingListAddress: string, managerAccountId: number, organizationName: string}): Promise<email.exchange.exchangeDistributionGroupManager>;
  /**
   * List the email.exchange.exchangeDistributionGroupMember objects
   * Mailing list account member
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/account', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<number[]>;
  /**
   * Mailing list members
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/account/{memberAccountId}', params: {exchangeService: string, mailingListAddress: string, memberAccountId: number, organizationName: string}): Promise<email.exchange.exchangeDistributionGroupMember>;
  /**
   * List the email.exchange.exchangeDistributionGroupMember objects
   * Mailing list contact member
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/contact', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<number[]>;
  /**
   * Mailing list members
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/contact/{memberContactId}', params: {exchangeService: string, mailingListAddress: string, memberContactId: number, organizationName: string}): Promise<email.exchange.exchangeDistributionGroupMember>;
  /**
   * List the email.exchange.exchangeDistributionGroupSendAs objects
   * sendAs
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendAs', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<number[]>;
  /**
   * Get users authorized to Send On Behalf To mails from this mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendAs/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.exchangeDistributionGroupSendAs>;
  /**
   * List the email.exchange.exchangeDistributionGroupSendOnBehalfTo objects
   * sendOnBehalfTo
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendOnBehalfTo', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<number[]>;
  /**
   * Get users authorized to Send On Behalf To mails from this mailing list
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendOnBehalfTo/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.exchangeDistributionGroupSendOnBehalfTo>;
  /**
   ...
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/protocol', params: {exchangeService: string, organizationName: string}): Promise<email.exchange.exchangeServiceProtocol>;
  /**
   ...
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/protocol/activeSyncMailNotification', params: {exchangeService: string, organizationName: string}): Promise<number[]>;
  /**
   * Get email addresses subscribed to ActiveSync quarantine notifications
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/protocol/activeSyncMailNotification/{notifiedAccountId}', params: {exchangeService: string, notifiedAccountId: number, organizationName: string}): Promise<email.exchange.exchangeServiceActiveSyncNotification>;
  /**
   * List the email.exchange.publicFolder objects
   * Public folders associated to this service
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolder', params: {exchangeService: string, organizationName: string, path?: string}): Promise<string[]>;
  /**
   * Exchange organization public folder
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolder/{path}', params: {exchangeService: string, organizationName: string, path: string}): Promise<email.exchange.publicFolder>;
  /**
   * List the email.exchange.exchangePublicFolderPermission objects
   * Public folder permission
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolder/{path}/permission', params: {exchangeService: string, organizationName: string, path: string}): Promise<number[]>;
  /**
   * Exchange organization public folder permission
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolder/{path}/permission/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, path: string}): Promise<email.exchange.exchangePublicFolderPermission>;
  /**
   * publicFolderQuota operations
   * Get public folder quota usage in total available space
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolderQuota', params: {exchangeService: string, organizationName: string}): Promise<email.exchange.PublicFolderQuota>;
  /**
   * List the email.exchange.resourceAccount objects
   * Resource account associated to this service
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount', params: {exchangeService: string, organizationName: string, resourceEmailAddress?: string}): Promise<string[]>;
  /**
   * Exchange resource account
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount/{resourceEmailAddress}', params: {exchangeService: string, organizationName: string, resourceEmailAddress: string}): Promise<email.exchange.resourceAccount>;
  /**
   * List the email.exchange.exchangeResourceAccountDelegate objects
   * Resource account manager
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount/{resourceEmailAddress}/delegate', params: {exchangeService: string, organizationName: string, resourceEmailAddress: string}): Promise<number[]>;
  /**
   * Resource accounts delegates
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount/{resourceEmailAddress}/delegate/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, resourceEmailAddress: string}): Promise<email.exchange.exchangeResourceAccountDelegate>;
  /**
   * Exchange server
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/server', params: {exchangeService: string, organizationName: string}): Promise<email.exchange.Server>;
  /**
   * Details about a Service
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/serviceInfos', params: {exchangeService: string, organizationName: string}): Promise<services.Service>;
  /**
   * List the email.exchange.sharedAccount objects
   * Shared accounts associated to this exchange service
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount', params: {exchangeService: string, organizationName: string, sharedEmailAddress?: string}): Promise<string[]>;
  /**
   * Exchange shared mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.sharedAccount>;
  /**
   * List the email.exchange.exchangeSharedAccountFullAccess objects
   * Full access granted users for this shared mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/fullAccess', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<number[]>;
  /**
   * Users having full access on this shared mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/fullAccess/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.exchangeSharedAccountFullAccess>;
  /**
   * List the email.exchange.exchangeSharedAccountSendAs objects
   * Send as granted users for this shared mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendAs', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<number[]>;
  /**
   * Users authorized to send mails from this shared mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendAs/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.exchangeSharedAccountSendAs>;
  /**
   * List the email.exchange.exchangeSharedAccountSendOnBehalfTo objects
   * SendOnBehalfTo granted users for this shared mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendOnBehalfTo', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<number[]>;
  /**
   * Get users authorized to Send On Behalf To mails from this shared mailbox
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendOnBehalfTo/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.exchangeSharedAccountSendOnBehalfTo>;
  /**
   * List the email.exchange.Task objects
   * Pending task for this mailbox
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/tasks', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<number[]>;
  /**
   * Exchange task details
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/tasks/{id}', params: {exchangeService: string, id: number, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * sharedAccountQuota operations
   * Get shared account quota usage in total available space
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccountQuota', params: {exchangeService: string, organizationName: string}): Promise<email.exchange.SharedAccountQuota>;
  /**
   * List the email.exchange.Task objects
   * Pending actions
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/task', params: {exchangeService: string, organizationName: string}): Promise<number[]>;
  /**
   * Exchange task details
   * Get this object properties
   */
  public get(path: '/email/exchange/{organizationName}/service/{exchangeService}/task/{id}', params: {exchangeService: string, id: number, organizationName: string}): Promise<email.exchange.Task>;
   ...
   * Alter this object properties
   */
  public put(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}/disclaimer', params: {domainName: string, exchangeService: string, organizationName: string, content?: string, creationDate?: string, name?: string, outsideOnly?: boolean, taskPendingId?: number}): Promise<void>;
  /**
   * External contact for this exchange service
   * Alter this object properties
   */
   ...
   * Create new alias
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/alias', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, alias: string}): Promise<email.exchange.Task>;
  /**
   * Exchange Account Archive
   * Create new archive mailbox
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/archive', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, quota?: number}): Promise<email.exchange.Task>;
  /**
   * changePassword operations
   * Change mailbox password
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/changePassword', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, password: string}): Promise<email.exchange.Task>;
  /**
   * Exchange Account Diagnosis
   * Create new diagnosis request
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/diagnostics', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, password: string}): Promise<email.exchange.Task>;
  /**
   * Export PST file request
   * Request PST file for the account
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/export', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Export PST file url
   * Generate temporary url to PST file
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/exportURL', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeAccountFullAccess objects
   * Allow full access to a user
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/fullAccess', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, allowedAccountId: number}): Promise<email.exchange.Task>;
  /**
   * Outlook url
   ...
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendAs', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, allowAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeAccountSendOnBehalfTo objects
   * Allow another user to Send On Behalf To mails from this mailbox
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendOnBehalfTo', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, allowAccountId: number}): Promise<email.exchange.Task>;
  /**
   * terminate operations
   * Terminate account at expiration date
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/terminate', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<string>;
  /**
   * activateSharepoint operations
   * Activate Sharepoint infra connected to this exchange service
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/activateSharepoint', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string, subDomain: string}): Promise<email.exchange.Task>;
  /**
   * changeHostname operations
   * Setting SSL hostname for Exchange private offer
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/changeHostname', params: {exchangeService: string, organizationName: string, dcvEmail: string, hostname: string, useDnsAssist: boolean}): Promise<email.exchange.Task>;
  /**
   ...
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/device/{identity}/clearDevice', params: {exchangeService: string, identity: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.Domain objects
   ...
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}/disclaimer', params: {domainName: string, exchangeService: string, organizationName: string, content: string, outsideOnly?: boolean}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeExternalContact objects
   ...
   * Create new alias
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/alias', params: {exchangeService: string, mailingListAddress: string, organizationName: string, alias: string}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeDistributionGroupManager objects
   * Add new mailing list manager
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/manager/account', params: {exchangeService: string, mailingListAddress: string, organizationName: string, managerAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeDistributionGroupMember objects
   * Add new mailing list member
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/account', params: {exchangeService: string, mailingListAddress: string, organizationName: string, memberAccountId?: number, memberContactId?: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeDistributionGroupMember objects
   * Add new mailing list member
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/contact', params: {exchangeService: string, mailingListAddress: string, organizationName: string, memberAccountId?: number, memberContactId?: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeDistributionGroupSendAs objects
   * Allow another user to Send aso mails from this mailing list
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendAs', params: {exchangeService: string, mailingListAddress: string, organizationName: string, allowAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeDistributionGroupSendOnBehalfTo objects
   * Allow another user to Send aso mails from this mailing list
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendOnBehalfTo', params: {exchangeService: string, mailingListAddress: string, organizationName: string, allowAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeServiceActiveSyncNotification objects
   * Subscribe new address to ActiveSync quarantine notifications
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/protocol/activeSyncMailNotification', params: {exchangeService: string, organizationName: string, notifiedAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.publicFolder objects
   ...
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/renewSSL', params: {exchangeService: string, organizationName: string, dcv: string}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.resourceAccount objects
   ...
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount/{resourceEmailAddress}/delegate', params: {exchangeService: string, organizationName: string, resourceEmailAddress: string, allowedAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.sharedAccount objects
   ...
   * Allow full access to a user
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/fullAccess', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string, allowedAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeSharedAccountSendAs objects
   * Allow another user to send mails from this shared mailbox
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendAs', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string, allowAccountId: number}): Promise<email.exchange.Task>;
  /**
   * List the email.exchange.exchangeSharedAccountSendOnBehalfTo objects
   * Allow another user to Send On Behalf To mails from this shared mailbox
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendOnBehalfTo', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string, allowAccountId: number}): Promise<email.exchange.Task>;
  /**
   * updateDeviceList operations
   * Update device list
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/updateDeviceList', params: {exchangeService: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * updateFlagsOnAllAccounts operations
   * Update spam and virus flags on all active accounts
   */
  public post(path: '/email/exchange/{organizationName}/service/{exchangeService}/updateFlagsOnAllAccounts', params: {exchangeService: string, organizationName: string}): Promise<void>;
   ...
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Aliases on this mailbox
   * Delete existing alias
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/alias/{alias}', params: {alias: string, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Exchange Account Archive
   * Delete existing archive mailbox
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/archive', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Export PST file request
   * Remove request of PST file
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/export', params: {exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Users having full access on this mailbox
   * Revoke full access
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/fullAccess/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Users authorized to send mails from this mailbox
   * Delete allowed user for sendAs
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendAs/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Get users authorized to Send On Behalf To mails from this mailbox
   * Delete allowed user for SendOnBehalfTo
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/account/{primaryEmailAddress}/sendOnBehalfTo/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, primaryEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Exchange domain
   * Delete existing domain in exchange services
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}', params: {domainName: string, exchangeService: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Exchange organization disclaimer
   * Delete existing organization disclaimer
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/domain/{domainName}/disclaimer', params: {domainName: string, exchangeService: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * External contact for this exchange service
   * delete external contact
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/externalContact/{externalEmailAddress}', params: {exchangeService: string, externalEmailAddress: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Mailing list
   * Delete mailing list
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}', params: {exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Get aliases on this mailingList
   * Delete existing alias
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/alias/{alias}', params: {alias: string, exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Mailing list managers
   * Delete mailing list manager
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/manager/account/{managerAccountId}', params: {exchangeService: string, mailingListAddress: string, managerAccountId: number, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Mailing list members
   * Delete mailing list member
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/account/{memberAccountId}', params: {exchangeService: string, mailingListAddress: string, memberAccountId: number, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Mailing list members
   * Delete mailing list member
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/member/contact/{memberContactId}', params: {exchangeService: string, mailingListAddress: string, memberContactId: number, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Get users authorized to Send On Behalf To mails from this mailbox
   * Delete allowed user for SendAs
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendAs/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Get users authorized to Send On Behalf To mails from this mailing list
   * Delete allowed user for SendOnBehalfTo
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/mailingList/{mailingListAddress}/sendOnBehalfTo/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, mailingListAddress: string, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Get email addresses subscribed to ActiveSync quarantine notifications
   * Unubscribe address from ActiveSync quarantine notifications
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/protocol/activeSyncMailNotification/{notifiedAccountId}', params: {exchangeService: string, notifiedAccountId: number, organizationName: string}): Promise<email.exchange.Task>;
  /**
   * Exchange organization public folder
   * Delete existing organization public folder
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolder/{path}', params: {exchangeService: string, organizationName: string, path: string}): Promise<email.exchange.Task>;
  /**
   * Exchange organization public folder permission
   * Delete existing permission from public folder
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/publicFolder/{path}/permission/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, path: string}): Promise<email.exchange.Task>;
  /**
   * Exchange resource account
   * delete existing resource account in exchange server
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount/{resourceEmailAddress}', params: {exchangeService: string, organizationName: string, resourceEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Resource accounts delegates
   * delete existing resource account delegate in exchange server
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/resourceAccount/{resourceEmailAddress}/delegate/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, resourceEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Exchange shared mailbox
   * Delete existing shared mailbox in exchange server
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}', params: {exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Users having full access on this shared mailbox
   * Revoke full access
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/fullAccess/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Users authorized to send mails from this shared mailbox
   * Delete allowed user for sendAs
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendAs/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.Task>;
  /**
   * Get users authorized to Send On Behalf To mails from this shared mailbox
   * Delete allowed user for SendOnBehalfTo
   */
  public delete(path: '/email/exchange/{organizationName}/service/{exchangeService}/sharedAccount/{sharedEmailAddress}/sendOnBehalfTo/{allowedAccountId}', params: {allowedAccountId: number, exchangeService: string, organizationName: string, sharedEmailAddress: string}): Promise<email.exchange.Task>;
