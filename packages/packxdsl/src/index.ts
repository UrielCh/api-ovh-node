...
export class ApiPackxdsl extends ApiCommon {
  ...
  **/
  ...
  public get(path: PathsPackxdslGET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Details about a Service
  ...
  **/
  ...
  public put(path: PathsPackxdslPUT, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  generate operations
  ...
  **/
  ...
  public post(path: PathsPackxdslPOST, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
}
