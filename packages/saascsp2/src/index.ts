...
type Pathssaascsp2POST = '/saas/csp2/{serviceName}/subscription/{id}/orderAddon' | 
...
class Apisaascsp2 extends ApiCommon {
  ...
  **/
  public put(path: '/saas/csp2/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Office tenant
  Alter this object properties
  **/
  public put(path: '/saas/csp2/{serviceName}', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: Pathssaascsp2PUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  orderAddon operations
  Creates a new subscription as an addon for this subscription
  **/
  public post(path: '/saas/csp2/{serviceName}/subscription/{id}/orderAddon', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<SaasCsp2OfficeTask>;
  /**
  changeQuantity operations
  Change the quantity of seats in the subscription
  **/
  public post(path: '/saas/csp2/{serviceName}/subscription/{id}/changeQuantity', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<SaasCsp2OfficeTask>;
  /**
  List the saas.csp2.OfficeSubscription objects
  Add a subscription to this tenant
  **/
  public post(path: '/saas/csp2/{serviceName}/subscription', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<SaasCsp2OfficeTask>;
  /**
  ...
  **/
  public post(path: '/saas/csp2/{serviceName}/configureDomain', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<SaasCsp2OfficeTask>;
  /**
  changeAdministratorPassword operations
  Changes the tenant administrator's password
  **/
  public post(path: '/saas/csp2/{serviceName}/changeAdministratorPassword', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<SaasCsp2OfficeTask>;
  public post(path: Pathssaascsp2POST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Office subscription
  Delete a subscription from this tenant
  **/
  public delete(path: '/saas/csp2/{serviceName}/subscription/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<SaasCsp2OfficeTask>;
  public delete(path: Pathssaascsp2DELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
