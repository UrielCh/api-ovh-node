...
export class ApiSaascsp2 extends ApiCommon {
  ...
  **/
  ...
  public get(path: PathsSaascsp2GET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Office tenant
  ...
  **/
  ...
  public put(path: PathsSaascsp2PUT, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.put(path, pathParams, bodyParams);}
  /**
  ...
  **/
  ...
  public post(path: PathsSaascsp2POST, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.post(path, pathParams, bodyParams);}
  /**
  Office subscription
  ...
  **/
  ...
  public delete(path: PathsSaascsp2DELETE, pathParams?: { [key:string]:string; }, bodyParams?: any) : Promise<any> {return super.delete(path, pathParams, bodyParams);}
}
