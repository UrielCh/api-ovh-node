...
type PathsPriceGET = '/price/domain/zone/option/{optionName}' | 
...
export class ApiPrice extends ApiCommon {
  ...
  **/
  ...
  public get(path: PathsPriceGET, pathParams?: { [key:string]:string; }, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
}
