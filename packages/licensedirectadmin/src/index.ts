...
type PathslicensedirectadminGET = '/license/directadmin/{serviceName}/tasks/{taskId}' | 
...
class Apilicensedirectadmin extends ApiCommon {
  ...
  **/
  public put(path: '/license/directadmin/{serviceName}', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Details about a Service
  Alter this object properties
  **/
  public put(path: '/license/directadmin/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathslicensedirectadminPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  Confirm termination of your service
  Confirm termination of your service
  **/
  public post(path: '/license/directadmin/{serviceName}/confirmTermination', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  changeIp operations
  Move this license to another Ip
  **/
  public post(path: '/license/directadmin/{serviceName}/changeIp', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<LicenseTask>;
  /**
  changeOs operations
  Change the Operating System for a license
  **/
  public post(path: '/license/directadmin/{serviceName}/changeOs', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<LicenseTask>;
  /**
  Terminate your service
  Terminate your service
  **/
  public post(path: '/license/directadmin/{serviceName}/terminate', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  public post(path: PathslicensedirectadminPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
}
