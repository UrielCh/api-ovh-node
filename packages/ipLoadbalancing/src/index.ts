...
type PathsipLoadbalancingPUT = '/ipLoadbalancing/{serviceName}/quota/{zone}' | 
'/ipLoadbalancing/{serviceName}/http/frontend/{frontendId}' | 
'/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}' | 
'/ipLoadbalancing/{serviceName}/http/route/{routeId}' | 
'/ipLoadbalancing/{serviceName}/http/farm/{farmId}' | 
...
type PathsipLoadbalancingPOST = '/ipLoadbalancing/{serviceName}/http/frontend' | 
'/ipLoadbalancing/{serviceName}/http/route' | 
'/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule' | 
'/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server' | 
'/ipLoadbalancing/{serviceName}/http/farm' | 
...
type PathsipLoadbalancingDELETE = '/ipLoadbalancing/{serviceName}/http/frontend/{frontendId}' | 
'/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}' | 
'/ipLoadbalancing/{serviceName}/http/route/{routeId}' | 
'/ipLoadbalancing/{serviceName}/http/farm/{farmId}' | 
'/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server/{serverId}' | 
...
class ApiipLoadbalancing extends ApiCommon {
  /**
  Operations about the IPLB service
  List available services
  **/
  public get(path: '/ipLoadbalancing', pathParams: null, queryParams: null): Promise<string[]>;
  /**
  Quota informations for current billing period for this zone
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/quota/{zone}', pathParams: {serviceName?: string, zone?: string}, queryParams: null): Promise<IpLoadbalancingQuotaQuota>;
  /**
  List the ipLoadbalancing.Quota.Quota objects
  Available quota informations for current billing period per zone
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/quota', pathParams: {serviceName?: string}, queryParams: null): Promise<string[]>;
  /**
  availableRouteRules operations
  Available route match rules
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/availableRouteRules', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingRouteAvailableRule[]>;
  /**
  IP Load Balancing Operations
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/task/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null): Promise<IpLoadbalancingTaskTask>;
  /**
  List the ipLoadbalancing.Task.Task objects
  Task for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/task', pathParams: {serviceName?: string}, queryParams: {'doneDate.from'?: Date, 'creationDate.to'?: Date, 'creationDate.from'?: Date, status?: IpLoadbalancingTaskStatusEnum, action?: IpLoadbalancingTaskActionEnum, 'doneDate.to'?: Date}): Promise<Number[]>;
  /**
  status operations
  Get the global status of your IPLB
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/status', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingStatus>;
  /**
  List the ipLoadbalancing.frontendHttp.FrontendHttp objects
  HTTP frontends for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/frontend', pathParams: {serviceName?: string}, queryParams: {port?: string, defaultFarmId?: Number, zone?: string}): Promise<Number[]>;
  /**
  Frontend HTTP
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null): Promise<IpLoadbalancingFrontendHttpFrontendHttp>;
  /**
  ...
  **/
  ...
  HTTP routes for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null): Promise<Number[]>;
  /**
  Rule of a route
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}', pathParams: {serviceName?: string, routeId?: Number, ruleId?: Number}, queryParams: null): Promise<IpLoadbalancingRouteRuleRouteRule>;
  /**
  HTTP Route
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null): Promise<IpLoadbalancingRouteHttpRouteHttp>;
  /**
  HTTP Farm
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null): Promise<IpLoadbalancingBackendHttpBackendHttp>;
  /**
  HTTP Farm's Server
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null): Promise<IpLoadbalancingBackendHttpCustomerServerBackendHTTPServer>;
  /**
  List the ipLoadbalancing.backendHttpCustomerServer.BackendHTTPServer objects
  HTTP Farm's Servers
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server', pathParams: {serviceName?: string, farmId?: Number}, queryParams: {address?: string, status?: IpLoadbalancingBackendCustomerServerStatusEnum, cookie?: string}): Promise<Number[]>;
  /**
  ...
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/availableRouteActions', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingRouteAvailableAction[]>;
  /**
  QuotaHistory
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/quotaHistory/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null): Promise<IpLoadbalancingQuotaHistoryQuotaHistory>;
  /**
  List the ipLoadbalancing.QuotaHistory.QuotaHistory objects
  Quota history informations, per month
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/quotaHistory', pathParams: {serviceName?: string}, queryParams: {zone?: string, 'historizedDate.to'?: Date, 'historizedDate.from'?: Date}): Promise<Number[]>;
  /**
  instancesState operations
  Get the effective state of your IPLB instances on IPLB servers
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/instancesState', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingInstancesState[]>;
  /**
  status operations
  Information about vRack for your Load Balancer
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/vrack/status', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingVrackInformation>;
  /**
  ...
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/vrack/network', pathParams: {serviceName?: string}, queryParams: {vlan?: Number, subnet?: string}): Promise<Number[]>;
  /**
  Represents a private network in the vRack
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/vrack/network/{vrackNetworkId}', pathParams: {serviceName?: string, vrackNetworkId?: Number}, queryParams: null): Promise<IpLoadbalancingVrackNetworkVrackNetwork>;
  /**
  networkCreationRules operations
  Rules to create a network attached to a vrack
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/vrack/networkCreationRules', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingVrackNetworkCreationRules>;
  /**
  availableFarmType operations
  Available farm types
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/availableFarmType', pathParams: {serviceName?: string}, queryParams: null): Promise<string[]>;
  /**
  failover operations
  List all failover ip routed to this IPLB
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/failover', pathParams: {serviceName?: string}, queryParams: null): Promise<string[]>;
  /**
  List the ipLoadbalancing.Ssl.Ssl objects
  Ssl for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/ssl', pathParams: {serviceName?: string}, queryParams: {type?: IpLoadbalancingSslTypeEnum, fingerprint?: string, serial?: string}): Promise<Number[]>;
  /**
  Ssl
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/ssl/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null): Promise<IpLoadbalancingSslSsl>;
  /**
  ...
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/definedFrontends', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingDefinedFrontend[]>;
  /**
  Frontend UDP
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null): Promise<IpLoadbalancingFrontendUdpFrontendUdp>;
  /**
  List the ipLoadbalancing.frontendUdp.FrontendUdp objects
  UDP frontends for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/udp/frontend', pathParams: {serviceName?: string}, queryParams: {port?: string, zone?: string, defaultFarmId?: Number}): Promise<Number[]>;
  /**
  List the ipLoadbalancing.backendUdp.BackendUdp objects
  UDP Farm for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/udp/farm', pathParams: {serviceName?: string}, queryParams: {zone?: string, vrackNetworkId?: Number}): Promise<Number[]>;
  /**
  ...
  **/
  ...
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null): Promise<IpLoadbalancingBackendUdpCustomerServerBackendUDPServer>;
  /**
  UDP Farm
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null): Promise<IpLoadbalancingBackendUdpBackendUdp>;
  /**
  IP Load Balancing Zone
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/zone/{name}', pathParams: {serviceName?: string, name?: string}, queryParams: null): Promise<IpLoadbalancingZoneZone>;
  /**
  List the ipLoadbalancing.Zone.Zone objects
  Zone for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/zone', pathParams: {serviceName?: string}, queryParams: null): Promise<string[]>;
  /**
  Your IP load balancing
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingIp>;
  /**
  pendingChanges operations
  List the pending changes on your Load Balancer configuration, per zone
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/pendingChanges', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingPendingChanges[]>;
  /**
  availableFarmProbes operations
  Available farm probes for health checks
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/availableFarmProbes', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingFarmAvailableProbe[]>;
  /**
  Details about a Service
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null): Promise<ServicesService>;
  /**
  natIp operations
  ...
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/natIp', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingNatIps[]>;
  /**
  availableFrontendType operations
  Available frontend type
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/availableFrontendType', pathParams: {serviceName?: string}, queryParams: null): Promise<string[]>;
  /**
  definedRoutes operations
  List of defined routes, and whether they are HTTP or TCP
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/definedRoutes', pathParams: {serviceName?: string}, queryParams: null): Promise<IpLoadbalancingDefinedRoute[]>;
  /**
  Rule of a route
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule/{ruleId}', pathParams: {serviceName?: string, routeId?: Number, ruleId?: Number}, queryParams: null): Promise<IpLoadbalancingRouteRuleRouteRule>;
  /**
  List the ipLoadbalancing.RouteRule.RouteRule objects
  HTTP routes for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null): Promise<Number[]>;
  /**
  TCP Route
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null): Promise<IpLoadbalancingRouteTcpRouteTcp>;
  /**
  ...
  **/
  ...
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null): Promise<IpLoadbalancingFrontendTcpFrontendTcp>;
  /**
  List the ipLoadbalancing.frontendTcp.FrontendTcp objects
  TCP frontends for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/frontend', pathParams: {serviceName?: string}, queryParams: {port?: string, defaultFarmId?: Number, zone?: string}): Promise<Number[]>;
  /**
  TCP Farm
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null): Promise<IpLoadbalancingBackendTcpBackendTcp>;
  /**
  List the ipLoadbalancing.backendTcpCustomerServer.BackendTCPServer objects
  TCP Farm's Servers
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}/server', pathParams: {serviceName?: string, farmId?: Number}, queryParams: {status?: IpLoadbalancingBackendCustomerServerStatusEnum, address?: string}): Promise<Number[]>;
  /**
  TCP Farm's Server
  Get this object properties
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null): Promise<IpLoadbalancingBackendTcpCustomerServerBackendTCPServer>;
  /**
  List the ipLoadbalancing.backendTcp.BackendTcp objects
  TCP Farm for this iplb
  **/
  public get(path: '/ipLoadbalancing/{serviceName}/tcp/farm', pathParams: {serviceName?: string}, queryParams: {zone?: string, vrackNetworkId?: Number}): Promise<Number[]>;
  /**
  List of zone available for an IP load balancing
  List of zone available for an IP load balancing
  **/
  public get(path: '/ipLoadbalancing/availableZones', pathParams: null, queryParams: null): Promise<string[]>;
  public get(path: PathsipLoadbalancingGET, pathParams?: any, queryParams?: any) : Promise<any> {return super.get(path, pathParams, queryParams);}
  /**
  Quota informations for current billing period for this zone
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/quota/{zone}', pathParams: {serviceName?: string, zone?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Frontend HTTP
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/http/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Rule of a route
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}', pathParams: {serviceName?: string, routeId?: Number, ruleId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  HTTP Route
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  HTTP Farm
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  HTTP Farm's Server
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Represents a private network in the vRack
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/vrack/network/{vrackNetworkId}', pathParams: {serviceName?: string, vrackNetworkId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Ssl
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/ssl/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Frontend UDP
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  UDP Farm's Server
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  UDP Farm
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Your IP load balancing
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Details about a Service
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Rule of a route
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule/{ruleId}', pathParams: {serviceName?: string, routeId?: Number, ruleId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  TCP Route
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Frontend TCP
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/tcp/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  TCP Farm
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  TCP Farm's Server
  Alter this object properties
  **/
  public put(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathsipLoadbalancingPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  List the ipLoadbalancing.frontendHttp.FrontendHttp objects
  Add a new http frontend on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/http/frontend', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingFrontendHttpFrontendHttp>;
  /**
  List the ipLoadbalancing.RouteHttp.RouteHttp objects
  Add a new HTTP route to your frontend
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/http/route', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingRouteHttpRouteHttp>;
  /**
  List the ipLoadbalancing.RouteRule.RouteRule objects
  Add a new rule to your route
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingRouteRuleRouteRule>;
  /**
  List the ipLoadbalancing.backendHttpCustomerServer.BackendHTTPServer objects
  Add a server to an HTTP Farm
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingBackendHttpCustomerServerBackendHTTPServer>;
  /**
  List the ipLoadbalancing.backendHttp.BackendHttp objects
  Add a new HTTP Farm on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/http/farm', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingBackendHttpBackendHttp>;
  /**
  List the ipLoadbalancing.VrackNetwork.VrackNetwork objects
  Add a description of a private network in the attached vRack
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/vrack/network', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingVrackNetworkVrackNetwork>;
  /**
  updateFarmId operations
  Update farm attached to that vrack network id
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/vrack/network/{vrackNetworkId}/updateFarmId', pathParams: {serviceName?: string, vrackNetworkId?: Number}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingVrackNetworkVrackNetwork>;
  /**
  Change the contacts of this service
  Launch a contact change procedure
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/changeContact', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<Number[]>;
  /**
  Confirm termination of your service
  Confirm termination of your service
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/confirmTermination', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  freeCertificate operations
  Order a free certificate. We order and deliver it for you
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/freeCertificate', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingTaskTask>;
  /**
  refresh operations
  Apply the configuration to your iplb
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/refresh', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingTaskTask>;
  /**
  List the ipLoadbalancing.Ssl.Ssl objects
  Add a new custom SSL certificate on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/ssl', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingSslSsl>;
  /**
  List the ipLoadbalancing.frontendUdp.FrontendUdp objects
  Add a new UDP frontend on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/udp/frontend', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingFrontendUdpFrontendUdp>;
  /**
  List the ipLoadbalancing.backendUdp.BackendUdp objects
  Add a new UDP Farm on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/udp/farm', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingBackendUdpBackendUdp>;
  /**
  List the ipLoadbalancing.backendUdpCustomerServer.BackendUDPServer objects
  Add a server to an UDP Farm
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingBackendUdpCustomerServerBackendUDPServer>;
  /**
  terminate operations
  Terminate your service zone option
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/zone/{name}/terminate', pathParams: {serviceName?: string, name?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  cancelTermination operations
  Cancel the termination request of your service zone option
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/zone/{name}/cancelTermination', pathParams: {serviceName?: string, name?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Terminate your service
  Terminate your service
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/terminate', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<string>;
  /**
  List the ipLoadbalancing.RouteRule.RouteRule objects
  Add a new rule to your route
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingRouteRuleRouteRule>;
  /**
  List the ipLoadbalancing.RouteTcp.RouteTcp objects
  Add a new TCP route to your frontend
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/tcp/route', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingRouteTcpRouteTcp>;
  /**
  List the ipLoadbalancing.frontendTcp.FrontendTcp objects
  Add a new TCP frontend on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/tcp/frontend', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingFrontendTcpFrontendTcp>;
  /**
  List the ipLoadbalancing.backendTcpCustomerServer.BackendTCPServer objects
  Add a server to a TCP Farm
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}/server', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingBackendTcpCustomerServerBackendTCPServer>;
  /**
  List the ipLoadbalancing.backendTcp.BackendTcp objects
  Add a new TCP Farm on your IP Load Balancing
  **/
  public post(path: '/ipLoadbalancing/{serviceName}/tcp/farm', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<IpLoadbalancingBackendTcpBackendTcp>;
  public post(path: PathsipLoadbalancingPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Frontend HTTP
  Delete an HTTP frontend
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/http/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Rule of a route
  Delete this rule from the route
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}/rule/{ruleId}', pathParams: {serviceName?: string, routeId?: Number, ruleId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  HTTP Route
  Delete this HTTP route
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/http/route/{routeId}', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  HTTP Farm
  Delete an HTTP Farm
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  HTTP Farm's Server
  Delete a server from an HTTP Farm
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/http/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Represents a private network in the vRack
  Delete this description of a private network in the vRack. It must not be used by any farm server
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/vrack/network/{vrackNetworkId}', pathParams: {serviceName?: string, vrackNetworkId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Ssl
  Delete a custom SSL certificate
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/ssl/{id}', pathParams: {serviceName?: string, id?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Frontend UDP
  Delete an UDP frontend
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/udp/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  UDP Farm's Server
  Delete a server from an UDP Farm
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  UDP Farm
  Delete an UDP Farm
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/udp/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Rule of a route
  Delete this rule from the route
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}/rule/{ruleId}', pathParams: {serviceName?: string, routeId?: Number, ruleId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  TCP Route
  Delete this TCP route
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/tcp/route/{routeId}', pathParams: {serviceName?: string, routeId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Frontend TCP
  Delete an TCP frontend
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/tcp/frontend/{frontendId}', pathParams: {serviceName?: string, frontendId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  TCP Farm
  Delete a TCP Farm
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}', pathParams: {serviceName?: string, farmId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  TCP Farm's Server
  Delete a server from a TCP Farm
  **/
  public delete(path: '/ipLoadbalancing/{serviceName}/tcp/farm/{farmId}/server/{serverId}', pathParams: {serviceName?: string, farmId?: Number, serverId?: Number}, queryParams: null, bodyParams: null): Promise<void>;
  public delete(path: PathsipLoadbalancingDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
