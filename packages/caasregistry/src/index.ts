...
type PathscaasregistryGET = '/caas/registry/{serviceName}/namespaces' | 
...
type PathscaasregistryDELETE = '/caas/registry/{serviceName}/namespaces/{namespaceId}/permissions/{permissionId}' | 
'/caas/registry/{serviceName}/namespaces/{namespaceId}/images/{imageId}/permissions/{permissionId}' | 
'/caas/registry/{serviceName}/namespaces/{namespaceId}/images/{imageId}' | 
'/caas/registry/{serviceName}/namespaces/{namespaceId}' | 
'/caas/registry/{serviceName}/users/{userId}';
...
class Apicaasregistry extends ApiCommon {
  ...
  **/
  ...
  Update image
  **/
  public put(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}/images/{imageId}', pathParams: {imageId?: string, namespaceId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<RegistryImage>;
  /**
  Details about a Service
  Alter this object properties
  **/
  public put(path: '/caas/registry/{serviceName}/serviceInfos', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public put(path: PathscaasregistryPUT, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.put(path, pathParams, queryParams, bodyParams);}
  /**
  Change the contacts of this service
  Launch a contact change procedure
  **/
  public post(path: '/caas/registry/{serviceName}/changeContact', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<Number[]>;
  /**
  Missing description
  Create namespace
  **/
  public post(path: '/caas/registry/{serviceName}/namespaces', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<RegistryNamespace>;
  /**
  Missing description
  Create namespace permissions
  **/
  public post(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}/permissions', pathParams: {namespaceId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<RegistryPermissions>;
  /**
  Missing description
  Create image permissions
  **/
  public post(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}/images/{imageId}/permissions', pathParams: {imageId?: string, namespaceId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<RegistryPermissions>;
  /**
  Missing description
  Update user password
  **/
  public post(path: '/caas/registry/{serviceName}/users/{userId}/changePassword', pathParams: {serviceName?: string, userId?: string}, queryParams: null, bodyParams: null): Promise<RegistryUser>;
  /**
  Missing description
  Create user
  **/
  public post(path: '/caas/registry/{serviceName}/users', pathParams: {serviceName?: string}, queryParams: null, bodyParams: null): Promise<RegistryUser>;
  public post(path: PathscaasregistryPOST, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.post(path, pathParams, queryParams, bodyParams);}
  /**
  Missing description
  Delete namespace permissions
  **/
  public delete(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}/permissions/{permissionId}', pathParams: {namespaceId?: string, permissionId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Missing description
  Delete image permissions.
  **/
  public delete(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}/images/{imageId}/permissions/{permissionId}', pathParams: {imageId?: string, namespaceId?: string, permissionId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Missing description
  Delete image
  **/
  public delete(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}/images/{imageId}', pathParams: {imageId?: string, namespaceId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Missing description
  Delete namespace
  **/
  public delete(path: '/caas/registry/{serviceName}/namespaces/{namespaceId}', pathParams: {namespaceId?: string, serviceName?: string}, queryParams: null, bodyParams: null): Promise<void>;
  /**
  Missing description
  Delete user
  **/
  public delete(path: '/caas/registry/{serviceName}/users/{userId}', pathParams: {serviceName?: string, userId?: string}, queryParams: null, bodyParams: null): Promise<void>;
  public delete(path: PathscaasregistryDELETE, pathParams?: any, queryParams?: any, bodyParams?:any) : Promise<any> {return super.delete(path, pathParams, queryParams, bodyParams);}
}
